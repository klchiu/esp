...
struct systolic_gemm3_vivado_access systolic_gemm3_cfg_000[] = {
	{
		/* <<--descriptor-->> */
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "systolic_gemm3_vivado.0",
		.ioctl_req = SYSTOLIC_GEMM3_VIVADO_IOC_ACCESS,
		.esp_desc = &(systolic_gemm3_cfg_000[0].esp),
	}
};
