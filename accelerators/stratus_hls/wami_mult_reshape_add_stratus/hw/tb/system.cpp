...
void system_t::config_proc()
{
    ...
    base_addr_2 = base_addr_1 + 36; // [humu]: use this for now, for input 2
    is_p2p      = 0;
    ...
    // Config
    {
        conf_info_t config(base_addr, nTestImages, 6, 1, padding_in, ADD_KERN_ID, base_addr_1, base_addr_2, 0, 0,
                           is_p2p);
    ...
    // Compute
    {
        ...
        ESP_REPORT_TIME(begin_time, "BEGIN - wami_mult_reshape_add");
        ...
        ESP_REPORT_TIME(end_time, "END - wami_mult_reshape_add");
