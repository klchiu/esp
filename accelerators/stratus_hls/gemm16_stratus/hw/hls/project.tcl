...
#
define_hls_module gemm16 ../src/gemm16.cpp

#
# Testbench or system level modules
#
define_system_module ../tb/gemm16_pv.c
...
foreach chk $DMA_CHUNK {
	...
	foreach word $WORD_SIZE {
		...
		foreach tb $TESTBENCHES {
		    ...
		    define_sim_config "BEHAV_$conf\_$tb" "gemm16 BEH" \
		...
		foreach cfg [list BASIC] {
		    ...
		    define_hls_config gemm16 $cname -io_config IOCFG_$conf \
			...
			if {$TECH_IS_XILINX == 1} {
			    define_sim_config "$cname\_$tb\_V" "gemm16 RTL_V $cname" \
				"tb TESTBENCH_$conf" -io_config IOCFG_$conf \
