...
#ifndef __GEMMENOUGH512_CONF_INFO_HPP__
#define __GEMMENOUGH512_CONF_INFO_HPP__
...
public:
    ...
    conf_info_t()
    {
        ...
        this->d2 = 512;
        this->d1 = 512;
        this->st_offset = 524288;
        this->ld_offset1 = 0;
        this->ld_offset2 = 262144;
    }
...
#endif // __GEMMENOUGH512_CONF_INFO_HPP__
