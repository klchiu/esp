...
#ifndef _WAMI_INV3_STRATUS_H_
#define _WAMI_INV3_STRATUS_H_
...
struct wami_inv3_stratus_access {
...
#define WAMI_INV3_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_inv3_stratus_access)

#endif /* _WAMI_INV3_STRATUS_H_ */
