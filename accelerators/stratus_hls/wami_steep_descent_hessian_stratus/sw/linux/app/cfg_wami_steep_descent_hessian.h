...
#ifndef __CFG_WAMI_STEEP_DESCENT_HESSIAN_H__
#define __CFG_WAMI_STEEP_DESCENT_HESSIAN_H__
...
struct wami_steep_descent_hessian_stratus_access wami_steep_descent_hessian_cfg[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_wami_steep_descent_hessian[] = {{
    .run       = true,
    .devname   = "wami_steep_descent_hessian_stratus.0",
    .ioctl_req = WAMI_STEEP_DESCENT_HESSIAN_STRATUS_IOC_ACCESS,
    .esp_desc  = &(wami_steep_descent_hessian_cfg[0].esp),
}};

#endif /* __CFG_WAMI_STEEP_DESCENT_HESSIAN_H__ */
