...
#define TF_ADD3_IMG_NUM_IMGS NUM_IMGS
#define TF_ADD3_IMG_NUM_ROWS (WAMI_DEBAYER_IMG_NUM_ROWS - (2 * PAD))
#define TF_ADD3_IMG_NUM_COLS (WAMI_DEBAYER_IMG_NUM_COLS - (2 * PAD))
