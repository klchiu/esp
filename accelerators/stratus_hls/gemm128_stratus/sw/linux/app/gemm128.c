			    ...
			    unsigned *in_size, unsigned *out_size, unsigned *size)
{
    ...
    *size = *in_size + *out_size;
    ...
    gemm128_cfg_000[0].do_relu = do_relu;
    gemm128_cfg_000[0].transpose = transpose;
    gemm128_cfg_000[0].ninputs = ninputs;
    gemm128_cfg_000[0].d1 = d1;
    gemm128_cfg_000[0].d2 = d2;
    gemm128_cfg_000[0].d3 = d3;
    gemm128_cfg_000[0].ld_offset1 = ld_offset1;
    gemm128_cfg_000[0].ld_offset2 = ld_offset2;
    gemm128_cfg_000[0].st_offset = st_offset;
