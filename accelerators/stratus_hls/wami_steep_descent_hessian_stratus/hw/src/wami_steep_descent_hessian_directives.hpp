...
#ifndef __WAMI_STEEP_DESCENT_HESSIAN_DIRECTIVES_HPP__
#define __WAMI_STEEP_DESCENT_HESSIAN_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_A0_in1           HLS_MAP_TO_MEMORY(A0_in1, "plm_a0b0_128x128")
    #define HLS_MAP_A0_in2           HLS_MAP_TO_MEMORY(A0_in2, "plm_a0b0_128x128")
    #define HLS_MAP_B0_steep_descent HLS_MAP_TO_MEMORY(B0_steep_descent, "plm_a0b0_6x128x128")

    #define HLS_MAP_A0_steepest_descent HLS_MAP_TO_MEMORY(A0_steepest_descent, "plm_a0b0_6x128x128")
    #define HLS_MAP_B0_hess             HLS_MAP_TO_MEMORY(B0_hess, "plm_a0b0_36 ")
    ...
    #define HLS_MAP_B0_steep_descent

    #define HLS_MAP_A0_steepest_descent
    #define HLS_MAP_B0_hess
...
#endif /* __WAMI_STEEP_DESCENT_HESSIAN_DIRECTIVES_HPP_ */
