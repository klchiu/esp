...
struct conv2dU8_2_stratus_access conv2dU8_2_cfg_000[] = {{
    /* <<--descriptor-->> */
...
esp_thread_info_t cfg_000[] = {{
    .run        = true,
    .devname    = "conv2dU8_2_stratus.0",
    .puffinname = "blue",
    .ioctl_req  = CONV2DU8_2_STRATUS_IOC_ACCESS,
    .esp_desc   = &(conv2dU8_2_cfg_000[0].esp),
}};
