...
struct gemmenough128_stratus_access gemmenough128_cfg_000[] = {
	{
		/* <<--descriptor-->> */
		.ninputs = NINPUTS,
		.d3 = D3,
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "gemmenough128_stratus.0",
		.ioctl_req = GEMMENOUGH128_STRATUS_IOC_ACCESS,
		.esp_desc = &(gemmenough128_cfg_000[0].esp),
	}
};
