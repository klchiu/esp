...
#ifndef __NIGHTHIST_HPP__
#define __NIGHTHIST_HPP__

#include "nightHist_conf_info.hpp"
#include "nightHist_debug_info.hpp"

#include "esp_templates.hpp"

#include "nightHist_directives.hpp"

#include "utils/esp_handshake.hpp"

class nightHist : public esp_accelerator_3P<DMA_WIDTH>
{
  public:
    // Output <-> Input
    ...
    // Constructor
    SC_HAS_PROCESS(nightHist);
    nightHist(const sc_module_name &name)
...
inline void nightHist::store_load_handshake()
{
    {
...
inline void nightHist::load_store_handshake()
{
    {
