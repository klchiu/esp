...
#ifndef _WAMI_WARP_XY_STRATUS_H_
#define _WAMI_WARP_XY_STRATUS_H_
...
struct wami_warp_xy_stratus_access {
...
#define WAMI_WARP_XY_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_warp_xy_stratus_access)

#endif /* _WAMI_WARP_XY_STRATUS_H_ */
