...
#ifndef _WAMI_SD_UPDATE3_STRATUS_H_
#define _WAMI_SD_UPDATE3_STRATUS_H_
...
struct wami_sd_update3_stratus_access {
...
#define WAMI_SD_UPDATE3_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_sd_update3_stratus_access)

#endif /* _WAMI_SD_UPDATE3_STRATUS_H_ */
