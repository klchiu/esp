...
#
define_hls_module gemmBig ../src/gemmBig.cpp
...
foreach chk $DMA_CHUNK {
	...
	foreach word $WORD_SIZE {
		...
		foreach tb $TESTBENCHES {
		    ...
		    define_sim_config "BEHAV_$conf\_$tb" "gemmBig BEH" \
		...
		foreach cfg [list BASIC] {
		    ...
		    define_hls_config gemmBig $cname -io_config IOCFG_$conf \
			...
			if {$TECH_IS_XILINX == 1} {
			    define_sim_config "$cname\_$tb\_V" "gemmBig RTL_V $cname" \
				"tb TESTBENCH_$conf" -io_config IOCFG_$conf \
