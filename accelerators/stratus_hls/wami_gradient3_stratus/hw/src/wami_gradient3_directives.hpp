...
#ifndef __WAMI_GRADIENT3_DIRECTIVES_HPP__
#define __WAMI_GRADIENT3_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_A0_grayscale  HLS_MAP_TO_MEMORY(A0_grayscale, "plm_a0b0_gradient_128x128")
    #define HLS_MAP_B0_gradient_x HLS_MAP_TO_MEMORY(B0_gradient_x, "plm_a0b0_gradient_128x128")
    #define HLS_MAP_B0_gradient_y HLS_MAP_TO_MEMORY(B0_gradient_y, "plm_a0b0_gradient_128x128")
    ...
    #define HLS_MAP_A0_grayscale
    #define HLS_MAP_B0_gradient_x
    #define HLS_MAP_B0_gradient_y
...
#endif /* __WAMI_GRADIENT3_DIRECTIVES_HPP_ */
