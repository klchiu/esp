...
#ifndef __TF_SUB3_FUNCTIONS_HPP__
#define __TF_SUB3_FUNCTIONS_HPP__
...
void tf_sub3::sub(uint32_t length)
{
    ...
    for (i = 0; i < length; i++) {
            ...
            HLS_UNROLL_LOOP(COMPLETE, 256, "unroll-sub-func");
...
#endif // __TF_SUB3_FUNCTIONS_HPP__
