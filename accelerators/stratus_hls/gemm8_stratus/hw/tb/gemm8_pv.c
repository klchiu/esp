...
void _gemm8_pv(double *mtx_inA, double *mtx_inB, double *mtx_out,
	      size_t is_trans, size_t rowsA, size_t colsA, size_t colsB)
{
	...
	cblas_dgemm8(CblasRowMajor,        // row-major order representation
...
void gemm8_pv(double_matrix_t *mtx_inA, double_matrix_t *mtx_inB, double_matrix_t **mtx_out)
{
    int i;
    ...
    for (i = 0; i < batch_size; ++i) {
        ...
        _gemm8_pv(&(mtx_inA->data[i * size_inA]),
