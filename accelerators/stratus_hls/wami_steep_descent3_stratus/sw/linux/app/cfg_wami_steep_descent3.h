...
#ifndef __CFG_WAMI_STEEP_DESCENT3_H__
#define __CFG_WAMI_STEEP_DESCENT3_H__
...
struct wami_steep_descent3_stratus_access wami_steep_descent3_cfg[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_wami_steep_descent3[] = {{
    .run       = true,
    .devname   = "wami_steep_descent3_stratus.0",
    .ioctl_req = WAMI_STEEP_DESCENT3_STRATUS_IOC_ACCESS,
    .esp_desc  = &(wami_steep_descent3_cfg[0].esp),
}};

#endif /* __CFG_WAMI_STEEP_DESCENT3_H__ */
