...
#ifndef _WAMI_STEEP_DESCENT_HESSIAN_STRATUS_H_
#define _WAMI_STEEP_DESCENT_HESSIAN_STRATUS_H_
...
struct wami_steep_descent_hessian_stratus_access {
...
#define WAMI_STEEP_DESCENT_HESSIAN_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_steep_descent_hessian_stratus_access)

#endif /* _WAMI_STEEP_DESCENT_HESSIAN_STRATUS_H_ */
