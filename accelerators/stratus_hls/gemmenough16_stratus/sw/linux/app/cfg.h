...
struct gemmenough16_stratus_access gemmenough16_cfg_000[] = {
	{
		/* <<--descriptor-->> */
		.ninputs = NINPUTS,
		.d3 = D3,
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "gemmenough16_stratus.0",
		.ioctl_req = GEMMENOUGH16_STRATUS_IOC_ACCESS,
		.esp_desc = &(gemmenough16_cfg_000[0].esp),
	}
};
