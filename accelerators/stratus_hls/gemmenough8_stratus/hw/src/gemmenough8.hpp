...
#ifndef __GEMMENOUGH8_HPP__
#define __GEMMENOUGH8_HPP__
...
class gemmenough8 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(gemmenough8);
    gemmenough8(const sc_module_name& name)
