...
struct gemmBig_stratus_access gemmBig_cfg_000[] = {
	{
		/* <<--descriptor-->> */
		.do_relu = DO_RELU,
		.transpose = TRANSPOSE,
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "gemmBig_stratus.0",
		.devname_noid = "gemmBig_stratus",
		.puffinname = "Blue Star",
		.ioctl_req = GEMMBIG_STRATUS_IOC_ACCESS,
		.esp_desc = &(gemmBig_cfg_000[0].esp),
	}
};
