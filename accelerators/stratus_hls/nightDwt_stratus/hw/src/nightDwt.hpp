...
#ifndef __NIGHTDWT_HPP__
#define __NIGHTDWT_HPP__

#include "nightDwt_conf_info.hpp"
#include "nightDwt_debug_info.hpp"

#include "esp_templates.hpp"

#include "nightDwt_directives.hpp"

#include "utils/esp_handshake.hpp"

class nightDwt : public esp_accelerator_3P<DMA_WIDTH>
{
  public:
    // Output <-> Input
    ...
    // Constructor
    SC_HAS_PROCESS(nightDwt);
    nightDwt(const sc_module_name &name)
...
inline void nightDwt::store_load_handshake()
{
    {
...
inline void nightDwt::load_store_handshake()
{
    {
