...
#ifndef __NIGHTNF_HPP__
#define __NIGHTNF_HPP__

#include "nightNF_conf_info.hpp"
#include "nightNF_debug_info.hpp"
...
class nightNF : public esp_accelerator_3P<DMA_WIDTH>
{
  public:
    // Output <-> Input
    ...
    // Constructor
    SC_HAS_PROCESS(nightNF);
    nightNF(const sc_module_name &name)
...
inline void nightNF::store_load_handshake()
{
    {
...
inline void nightNF::load_store_handshake()
{
    {
