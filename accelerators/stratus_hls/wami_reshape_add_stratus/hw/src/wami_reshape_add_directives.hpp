...
#ifndef __WAMI_RESHAPE_ADD_DIRECTIVES_HPP__
#define __WAMI_RESHAPE_ADD_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_A0_delta_p    HLS_MAP_TO_MEMORY(A0_delta_p, "plm_reshape_add_6")
    #define HLS_MAP_B0_sd_delta_p HLS_MAP_TO_MEMORY(B0_sd_delta_p, "plm_reshape_add_6")

    #define HLS_MAP_A0_affine_params HLS_MAP_TO_MEMORY(A0_affine_params, "plm_reshape_add_6")
    #define HLS_MAP_A0_sd_delta_p    HLS_MAP_TO_MEMORY(A0_sd_delta_p, "plm_reshape_add_6")
    #define HLS_MAP_B0_affine_params HLS_MAP_TO_MEMORY(B0_affine_params, "plm_reshape_add_6")
    ...
    #define HLS_MAP_A0_delta_p
    #define HLS_MAP_B0_sd_delta_p
...
#endif /* __WAMI_RESHAPE_ADD_DIRECTIVES_HPP_ */
