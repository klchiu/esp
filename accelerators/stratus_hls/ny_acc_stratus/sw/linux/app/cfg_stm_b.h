...
struct ny_acc_stratus_access ny_acc_cfg_stm_b_4[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
struct ny_acc_stratus_access ny_acc_cfg_stm_b_5[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_ny_acc_4_stm_b[] = {{
    .run       = true,
    .devname   = "ny_acc_stratus.4",
    .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
    .esp_desc  = &(ny_acc_cfg_stm_b_4[0].esp),
}};

esp_thread_info_t cfg_ny_acc_5_stm_b[] = {{
    .run       = true,
    .devname   = "ny_acc_stratus.5",
    .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
    .esp_desc  = &(ny_acc_cfg_stm_b_5[0].esp),
}};
