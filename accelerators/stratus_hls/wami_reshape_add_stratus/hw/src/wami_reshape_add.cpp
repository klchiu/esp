...
#include "wami_reshape_add_functions.hpp"

// Processes

void wami_reshape_add::load_input()
{
...
void wami_reshape_add::store_output()
{
...
void wami_reshape_add::compute_kernel()
{
    uint32_t img_num_img = 0;
    // Reset
    {
