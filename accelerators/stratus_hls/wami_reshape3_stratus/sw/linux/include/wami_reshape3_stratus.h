...
#ifndef _WAMI_RESHAPE3_STRATUS_H_
#define _WAMI_RESHAPE3_STRATUS_H_
...
struct wami_reshape3_stratus_access {
...
#define WAMI_RESHAPE3_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_reshape3_stratus_access)

#endif /* _WAMI_RESHAPE3_STRATUS_H_ */
