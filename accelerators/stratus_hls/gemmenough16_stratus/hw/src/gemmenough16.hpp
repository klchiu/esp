...
#ifndef __GEMMENOUGH16_HPP__
#define __GEMMENOUGH16_HPP__
...
class gemmenough16 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(gemmenough16);
    gemmenough16(const sc_module_name& name)
