...
#ifndef __HUANGEMM3S16_HPP__
#define __HUANGEMM3S16_HPP__
...
class huangemm3s16 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(huangemm3s16);
    huangemm3s16(const sc_module_name& name)
