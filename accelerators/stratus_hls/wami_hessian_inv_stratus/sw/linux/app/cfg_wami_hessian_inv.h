...
#ifndef __CFG_WAMI_HESSIAN_INV_H__
#define __CFG_WAMI_HESSIAN_INV_H__
...
struct wami_hessian_inv_stratus_access wami_hessian_inv_cfg[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_wami_hessian_inv[] = {{
    .run       = true,
    .devname   = "wami_hessian_inv_stratus.0",
    .ioctl_req = WAMI_HESSIAN_INV_STRATUS_IOC_ACCESS,
    .esp_desc  = &(wami_hessian_inv_cfg[0].esp),
}};

#endif /* __CFG_WAMI_HESSIAN_INV_H__ */
