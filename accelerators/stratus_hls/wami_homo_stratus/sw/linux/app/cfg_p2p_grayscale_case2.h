...
#ifndef __CFG_P2P_GRAYSCALE_CASE2_H__
#define __CFG_P2P_GRAYSCALE_CASE2_H__
...
struct wami_homo_stratus_access wami_grayscale3_cfg_p2p_case2[] = {
    ...
    // wami_grayscale3_stratus.7
     {
        ...
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
        .esp.p2p_srcs          = {"wami_grayscale3_stratus.12", "", "", ""},
    },
...
esp_thread_info_t cfg_wami_p2p_grayscale3_case2[] = {
    /* blank placeholder for formatter */
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.0",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[0].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.1",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[1].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.2",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[2].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.3",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[3].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.4",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[4].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.5",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[5].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.6",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[6].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.7",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[7].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.8",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[8].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.9",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[9].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.10",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[10].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.11",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[11].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.12",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[12].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.13",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[13].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.14",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[14].esp),
    },
    {
        .run       = true,
        .devname   = "wami_grayscale3_stratus.15",
        .ioctl_req = WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_grayscale3_cfg_p2p_case2[15].esp),
    }};

#endif /* __CFG_P2P_GRAYSCALE_CASE2_H__ */
