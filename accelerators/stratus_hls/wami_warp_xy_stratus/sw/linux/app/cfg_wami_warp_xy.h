...
#ifndef __CFG_WAMI_WARP_XY_H__
#define __CFG_WAMI_WARP_XY_H__
...
struct wami_warp_xy_stratus_access wami_warp_xy_cfg[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_wami_warp_xy[] = {{
    .run       = true,
    .devname   = "wami_warp_xy_stratus.0",
    .ioctl_req = WAMI_WARP_XY_STRATUS_IOC_ACCESS,
    .esp_desc  = &(wami_warp_xy_cfg[0].esp),
}};

#endif /* __CFG_WAMI_WARP_XY_H__ */
