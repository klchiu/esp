...
#ifndef __WAMI_MULT3_DIRECTIVES_HPP__
#define __WAMI_MULT3_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_B0_delta_p    HLS_MAP_TO_MEMORY(B0_delta_p, "plm_a0b0_6")
...
#endif /* __WAMI_MULT3_DIRECTIVES_HPP_ */
