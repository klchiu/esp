...
#ifndef __WAMI_HESSIAN3_HPP__
#define __WAMI_HESSIAN3_HPP__
...
#include "wami_hessian3_debug_info.hpp"
...
class wami_hessian3 : public esp_accelerator_3P<DMA_WIDTH>
{
  public:
    // Output <-> Input
    ...
    // Constructor
    SC_HAS_PROCESS(wami_hessian3);
    wami_hessian3(const sc_module_name &name)
...
inline void wami_hessian3::store_load_handshake()
{
    {
...
inline void wami_hessian3::load_store_handshake()
{
    {
