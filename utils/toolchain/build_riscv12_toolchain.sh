...
# tag: 2023.02.25
RISCV_GNU_TOOLCHAIN_SHA=f0b00941ec640bfdbe31304820892fe9d490f9bb
# tag: 2022.11.2
BUILDROOT_SHA=71ddf1a0848e7b17c220b759ffae30ea2b13e1a8
...
DEFAULT_TARGET_DIR="/home/${USER}/toolchains/riscv12"
...
if [ $(noyes "Skip buildroot?") == "n" ]; then
    ...
    # git submodule update --init --recursive
    make distclean
    make defconfig BR2_DEFCONFIG=${SCRIPT_PATH}/riscv12_buildroot_defconfig
    make -j ${NTHREADS}
