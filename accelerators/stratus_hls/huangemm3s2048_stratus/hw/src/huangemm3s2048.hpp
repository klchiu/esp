...
#ifndef __HUANGEMM3S2048_HPP__
#define __HUANGEMM3S2048_HPP__

#include "huangemm3s2048_conf_info.hpp"
#include "huangemm3s2048_debug_info.hpp"

#include "esp_templates.hpp"

#include "huangemm3s2048_directives.hpp"
...
class huangemm3s2048 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(huangemm3s2048);
    huangemm3s2048(const sc_module_name& name)
