...
#ifndef __WAMI_SUB3_DIRECTIVES_HPP__
#define __WAMI_SUB3_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_A0_in1 HLS_MAP_TO_MEMORY(A0_in1, "plm_a0b0_sub_16384")
    #define HLS_MAP_A0_in2 HLS_MAP_TO_MEMORY(A0_in2, "plm_a0b0_sub_16384")
    #define HLS_MAP_B0_out HLS_MAP_TO_MEMORY(B0_out, "plm_a0b0_sub_16384")
...
#endif /* __WAMI_SUB3_DIRECTIVES_HPP_ */
