...
#ifndef __GEMMU8_HPP__
#define __GEMMU8_HPP__

#include "gemmU8_data.hpp"
#include "fpdata.hpp"
#include "gemmU8_conf_info.hpp"
#include "gemmU8_debug_info.hpp"
#include "esp_templates.hpp"
#include "gemmU8_directives.hpp"
#include "common.hpp"

#define __round_mask(x, y) ((y)-1)
#define round_up(x, y) ((((x)-1) | __round_mask(x, y))+1)

class gemmU8 : public esp_accelerator_3P<DMA_WIDTH>
{
public:

    // Constructor
    SC_HAS_PROCESS(gemmU8);
    gemmU8(const sc_module_name& name)
