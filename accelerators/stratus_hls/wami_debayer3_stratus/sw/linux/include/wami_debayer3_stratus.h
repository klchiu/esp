...
#ifndef _WAMI_DEBAYER3_STRATUS_H_
#define _WAMI_DEBAYER3_STRATUS_H_
...
struct wami_debayer3_stratus_access {
...
#define WAMI_DEBAYER3_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_debayer3_stratus_access)

#endif /* _WAMI_DEBAYER3_STRATUS_H_ */
