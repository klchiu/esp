...
#ifndef __GEMMENOUGH256_HPP__
#define __GEMMENOUGH256_HPP__
...
#define PLM_OUT_WORD 131072
#define PLM_IN_WORD 131072

class gemmenough256 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(gemmenough256);
    gemmenough256(const sc_module_name& name)
