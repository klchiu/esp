			    ...
			    unsigned *in_size, unsigned *out_size, unsigned *size)
{
    ...
    *size = *in_size + *out_size;
    ...
    gemmBig_cfg_000[0].do_relu = do_relu;
    gemmBig_cfg_000[0].transpose = transpose;
    gemmBig_cfg_000[0].ninputs = ninputs;
    gemmBig_cfg_000[0].d1 = d1;
    gemmBig_cfg_000[0].d2 = d2;
    gemmBig_cfg_000[0].d3 = d3;
    gemmBig_cfg_000[0].ld_offset1 = ld_offset1;
    gemmBig_cfg_000[0].ld_offset2 = ld_offset2;
    gemmBig_cfg_000[0].st_offset = st_offset;
