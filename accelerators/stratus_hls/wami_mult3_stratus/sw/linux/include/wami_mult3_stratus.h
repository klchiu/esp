...
#ifndef _WAMI_MULT3_STRATUS_H_
#define _WAMI_MULT3_STRATUS_H_
...
struct wami_mult3_stratus_access {
...
#define WAMI_MULT3_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_mult3_stratus_access)

#endif /* _WAMI_MULT3_STRATUS_H_ */
