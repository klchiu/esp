...
#ifndef __CFG_WAMI_ADD3_H__
#define __CFG_WAMI_ADD3_H__
...
struct wami_add3_stratus_access wami_add3_cfg[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_wami_add3[] = {{
    .run       = true,
    .devname   = "wami_add3_stratus.0",
    .ioctl_req = WAMI_ADD3_STRATUS_IOC_ACCESS,
    .esp_desc  = &(wami_add3_cfg[0].esp),
}};

#endif /* __CFG_WAMI_ADD3_H__ */
