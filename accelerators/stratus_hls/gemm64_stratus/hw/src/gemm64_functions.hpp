...
inline void gemm64::calculate_config(uint24_t ninputs,
				   uint24_t matrix_d1,
				   uint24_t matrix_d2,
				   uint24_t matrix_d3,
				   bool transpose,
...
inline void gemm64::calculate_chunks(uint24_t  &matrix_chk,
				   uint16_t &matrix_rem,
				   uint32_t matrix_d2,
				   bool in_or_out)
{
...
inline void gemm64::sync_compute_store(uint16_t &count, uint16_t loaded_rows,
...
inline void gemm64::load_compute_cfg_handshake()
{
...
inline void gemm64::compute_load_cfg_handshake()
{
...
inline void gemm64::load_store_cfg_handshake()
{
...
inline void gemm64::store_load_cfg_handshake()
{
