...
#ifndef __WAMI_HESSIAN3_DIRECTIVES_HPP__
#define __WAMI_HESSIAN3_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_A0_steepest_descent HLS_MAP_TO_MEMORY(A0_steepest_descent, "plm_a0b0_hessian_6x16384")
    #define HLS_MAP_B0_hess             HLS_MAP_TO_MEMORY(B0_hess, "plm_a0b0_hessian_36 ")
...
#endif /* __WAMI_HESSIAN3_DIRECTIVES_HPP_ */
