...
#ifndef __HUANGEMM3s10000_HPP__
#define __HUANGEMM3s10000_HPP__

#include "huangemm3s10000_conf_info.hpp"
#include "huangemm3s10000_debug_info.hpp"
...
#define PLM_OUT_WORD 10000
// #define PLM_IN_WORD 326782
#define PLM_IN_WORD 10000

class huangemm3s10000 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(huangemm3s10000);
    huangemm3s10000(const sc_module_name& name)
