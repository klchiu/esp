...
#ifndef __WAMI_SD_UPDATE3_DIRECTIVES_HPP__
#define __WAMI_SD_UPDATE3_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_A0_subtract         HLS_MAP_TO_MEMORY(A0_subtract, "plm_a0b0_128x128")
    #define HLS_MAP_B0_sd_update        HLS_MAP_TO_MEMORY(B0_sd_update, "plm_a0b0_6")
    ...
    #define HLS_MAP_A0_subtract
    #define HLS_MAP_B0_sd_update
...
#endif /* __WAMI_SD_UPDATE3_DIRECTIVES_HPP_ */
