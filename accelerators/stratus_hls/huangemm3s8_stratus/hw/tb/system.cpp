...
void system_t::config_proc()
{
    ...
    // Compute
    {
        ...
        ESP_REPORT_TIME(begin_time, "BEGIN - huan_huangemm3s8");
        ...
        ESP_REPORT_TIME(end_time, "END - huan_huangemm3s8");
...
void system_t::load_memory()
{
    ...
    // for (int i = 0; i < huangemm3s8_n; i++)
    //     for (int j = 0; j < huangemm3s8_len * huangemm3s8_vec; j++)
    //         in[i * in_words_adj + j] = j % huangemm3s8_vec;
...
int system_t::validate()
{
    ...
    // for (int i = 0; i < huangemm3s8_n; i++)
    //     for (int j = 0; j < huangemm3s8_vec; j++)
