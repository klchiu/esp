...
#
define_hls_module gemm128 ../src/gemm128.cpp

#
# Testbench or system level modules
#
define_system_module ../tb/gemm128_pv.c
...
foreach chk $DMA_CHUNK {
	...
	foreach word $WORD_SIZE {
		...
		foreach tb $TESTBENCHES {
		    ...
		    define_sim_config "BEHAV_$conf\_$tb" "gemm128 BEH" \
		...
		foreach cfg [list BASIC] {
		    ...
		    define_hls_config gemm128 $cname -io_config IOCFG_$conf \
			...
			if {$TECH_IS_XILINX == 1} {
			    define_sim_config "$cname\_$tb\_V" "gemm128 RTL_V $cname" \
				"tb TESTBENCH_$conf" -io_config IOCFG_$conf \
