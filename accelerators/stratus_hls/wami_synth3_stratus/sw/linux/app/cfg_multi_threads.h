...
struct wami_synth3_stratus_access wami_synth3_cfg_mtm[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_wami_synth3_0_mtm[] = {{
    .run       = true,
    .devname   = "wami_synth3_stratus.0",
    .ioctl_req = WAMI_SYNTH3_STRATUS_IOC_ACCESS,
    .esp_desc  = &(wami_synth3_cfg_mtm[0].esp),
}};

esp_thread_info_t cfg_wami_synth3_1_mtm[] = {{
    .run       = true,
...
esp_thread_info_t cfg_wami_synth3_2_mtm[] = {{
    .run       = true,
...
esp_thread_info_t cfg_wami_synth3_3_mtm[] = {{
    .run       = true,
...
esp_thread_info_t cfg_wami_synth3_4_mtm[] = {{
    .run       = true,
...
esp_thread_info_t cfg_wami_synth3_5_mtm[] = {{
    .run       = true,
...
esp_thread_info_t cfg_wami_synth3_6_mtm[] = {{
    .run       = true,
...
esp_thread_info_t cfg_wami_synth3_7_mtm[] = {{
    .run       = true,
