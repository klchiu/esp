...
void validate_buf(token_t *buf)
{
    ...
    if (error_count > 0) {
        printf("wami_synth4: error: %d\n", error_count);
    } else {
        printf("wami_synth4: Correct!!!\n");
    }
    printf("------- validate_buf, finish\n");
}

//--------------------------------------------------------------------------------------
void run_synth3_0_mtm_a(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_0_mtm_a, 1);
}
void run_synth3_1_mtm_a(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_1_mtm_a, 1);
}
void run_synth3_2_mtm_a(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_2_mtm_a, 1);
}
void run_synth3_3_mtm_a(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_3_mtm_a, 1);
}
void run_synth3_4_mtm_a(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_4_mtm_a, 1);
}
void run_synth3_5_mtm_a(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_5_mtm_a, 1);
}

void run_synth3_0_mtm_b(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_0_mtm_b, 1);
}
void run_synth3_1_mtm_b(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_1_mtm_b, 1);
}
void run_synth3_2_mtm_b(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_2_mtm_b, 1);
}
void run_synth3_3_mtm_b(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_3_mtm_b, 1);
}
void run_synth3_4_mtm_b(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_4_mtm_b, 1);
}
void run_synth3_5_mtm_b(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_5_mtm_b, 1);
}

void run_synth3_0_mtm_c(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_0_mtm_c, 1);
}
void run_synth3_1_mtm_c(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_1_mtm_c, 1);
}
void run_synth3_2_mtm_c(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_2_mtm_c, 1);
}
void run_synth3_3_mtm_c(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_3_mtm_c, 1);
}
void run_synth3_4_mtm_c(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_4_mtm_c, 1);
}
void run_synth3_5_mtm_c(void *ptr)
{
    esp_run_no_print(cfg_wami_synth4_5_mtm_c, 1);
}

void test_mtm_a(token_t *buf, int num_col, int num_row, int delay, int test_batch)
{
    cfg_wami_synth4_0_mtm_a[0].hw_buf = buf;
    cfg_wami_synth4_1_mtm_a[0].hw_buf = buf;
    cfg_wami_synth4_2_mtm_a[0].hw_buf = buf;
    cfg_wami_synth4_3_mtm_a[0].hw_buf = buf;
    cfg_wami_synth4_4_mtm_a[0].hw_buf = buf;
    cfg_wami_synth4_5_mtm_a[0].hw_buf = buf;

    struct wami_synth4_stratus_access *tmp;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_0_mtm_a[0].esp_desc;
...
{
    cfg_wami_synth4_0_mtm_b[0].hw_buf = buf;
    cfg_wami_synth4_1_mtm_b[0].hw_buf = buf;
    cfg_wami_synth4_2_mtm_b[0].hw_buf = buf;
    cfg_wami_synth4_3_mtm_b[0].hw_buf = buf;
    cfg_wami_synth4_4_mtm_b[0].hw_buf = buf;
    cfg_wami_synth4_5_mtm_b[0].hw_buf = buf;

    struct wami_synth4_stratus_access *tmp;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_0_mtm_b[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_1_mtm_b[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col * 2;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_2_mtm_b[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_3_mtm_b[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_4_mtm_b[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row * 2;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_5_mtm_b[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
...
{
    cfg_wami_synth4_0_mtm_c[0].hw_buf = buf;
    cfg_wami_synth4_1_mtm_c[0].hw_buf = buf;
    cfg_wami_synth4_2_mtm_c[0].hw_buf = buf;
    cfg_wami_synth4_3_mtm_c[0].hw_buf = buf;
    cfg_wami_synth4_4_mtm_c[0].hw_buf = buf;
    cfg_wami_synth4_5_mtm_c[0].hw_buf = buf;

    struct wami_synth4_stratus_access *tmp;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_0_mtm_c[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_1_mtm_c[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row * 2;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_2_mtm_c[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_3_mtm_c[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_4_mtm_c[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col * 2;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_5_mtm_c[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
...
void test_stm_1(token_t *buf, int num_col, int num_row, int delay, int test_batch, char *puffinname)
{
    cfg_wami_synth4_stm_1[0].hw_buf = buf;

    struct wami_synth4_stratus_access *tmp;
    tmp = (struct wami_synth4_stratus_access *)cfg_wami_synth4_stm_1[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col                   = num_col;
    tmp->wami_num_row                   = num_row;
    tmp->wami_batch                     = delay;
    cfg_wami_synth4_stm_1[0].puffinname = puffinname;
    ...
    printf("[%s] [stm_1] load time: %llu\n", puffinname, time_s);

    gettime(&t_test_1);
    for (i = 0; i < test_batch; i++) {
        esp_run(cfg_wami_synth4_stm_1, 1);
    }
    gettime(&t_test_2);
    time_s = ts_subtract(&t_test_1, &t_test_2);

    printf("[%s] [stm_1] compute time: %llu\n", puffinname, time_s);
    ...
    printf("[%s] [stm_1] validate time: %llu\n", puffinname, time_s);

    printf("[%s] [stm_1] col_load: %d\trow_store: %d\tdelay: %d\tbatch: %d\n", puffinname, num_col, num_row, delay, test_batch);

}

void test_stm_2(token_t *buf, int num_col, int num_row, int delay, int test_batch)
{
    cfg_wami_synth4_stm_1[0].hw_buf = buf;
    cfg_wami_synth4_stm_1[1].hw_buf = buf;
    ...
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_stm_1[1].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    ...
    printf("[stm_1] load time: %llu\n", time_s);

    gettime(&t_test_1);
    for (i = 0; i < test_batch; i++) {
        esp_run(cfg_wami_synth4_stm_1, 2);
    }
    gettime(&t_test_2);
    time_s = ts_subtract(&t_test_1, &t_test_2);

    printf("[stm_1] compute time: %llu\n", time_s);
    ...
    printf("[stm_1] validate time: %llu\n", time_s);

    printf("[stm_1] col_load: %d\trow_store: %d\tdelay: %d\tbatch: %d\n", num_col, num_row, delay, test_batch);
}

void test_stm_a(token_t *buf, int num_col, int num_row, int delay, int test_batch)
{
    cfg_wami_synth4_0_stm_a[0].hw_buf = buf;
    cfg_wami_synth4_1_stm_a[0].hw_buf = buf;
    cfg_wami_synth4_2_stm_a[0].hw_buf = buf;
    cfg_wami_synth4_3_stm_a[0].hw_buf = buf;
    cfg_wami_synth4_4_stm_a[0].hw_buf = buf;
    cfg_wami_synth4_5_stm_a[0].hw_buf = buf;

    struct wami_synth4_stratus_access *tmp;
    tmp = (struct wami_synth4_stratus_access *)cfg_wami_synth4_0_stm_a[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    ...
    gettime(&t_test_1);
    for (i = 0; i < test_batch; i++) {
        esp_run_no_print(cfg_wami_synth4_0_stm_a, 1);
        esp_run_no_print(cfg_wami_synth4_1_stm_a, 1);
        esp_run_no_print(cfg_wami_synth4_2_stm_a, 1);
        esp_run_no_print(cfg_wami_synth4_3_stm_a, 1);
        esp_run_no_print(cfg_wami_synth4_4_stm_a, 1);
        esp_run_no_print(cfg_wami_synth4_5_stm_a, 1);
    }
    gettime(&t_test_2);
...
{
    cfg_wami_synth4_0_stm_b[0].hw_buf = buf;
    cfg_wami_synth4_1_stm_b[0].hw_buf = buf;
    cfg_wami_synth4_2_stm_b[0].hw_buf = buf;
    cfg_wami_synth4_3_stm_b[0].hw_buf = buf;
    cfg_wami_synth4_4_stm_b[0].hw_buf = buf;
    cfg_wami_synth4_5_stm_b[0].hw_buf = buf;

    struct wami_synth4_stratus_access *tmp;
    tmp = (struct wami_synth4_stratus_access *)cfg_wami_synth4_0_stm_b[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_1_stm_b[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col * 2;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_2_stm_b[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_3_stm_b[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_4_stm_b[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row * 2;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_5_stm_b[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    ...
    gettime(&t_test_1);
    for (i = 0; i < test_batch; i++) {
        esp_run_no_print(cfg_wami_synth4_0_stm_b, 1);
        esp_run_no_print(cfg_wami_synth4_1_stm_b, 1);
        esp_run_no_print(cfg_wami_synth4_2_stm_b, 1);
        esp_run_no_print(cfg_wami_synth4_3_stm_b, 1);
        esp_run_no_print(cfg_wami_synth4_4_stm_b, 1);
        esp_run_no_print(cfg_wami_synth4_5_stm_b, 1);
    }
    gettime(&t_test_2);
...
{
    cfg_wami_synth4_0_stm_c[0].hw_buf = buf;
    cfg_wami_synth4_1_stm_c[0].hw_buf = buf;
    cfg_wami_synth4_2_stm_c[0].hw_buf = buf;
    cfg_wami_synth4_3_stm_c[0].hw_buf = buf;
    cfg_wami_synth4_4_stm_c[0].hw_buf = buf;
    cfg_wami_synth4_5_stm_c[0].hw_buf = buf;

    struct wami_synth4_stratus_access *tmp;
    tmp = (struct wami_synth4_stratus_access *)cfg_wami_synth4_0_stm_c[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_1_stm_c[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row * 2;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_2_stm_c[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_3_stm_c[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_4_stm_c[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col * 2;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_5_stm_c[0].esp_desc;
    // tmp->wami_num_img      = 100;    // test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    ...
    gettime(&t_test_1);
    for (i = 0; i < test_batch; i++) {
        esp_run_no_print(cfg_wami_synth4_0_stm_c, 1);
        esp_run_no_print(cfg_wami_synth4_1_stm_c, 1);
        esp_run_no_print(cfg_wami_synth4_2_stm_c, 1);
        esp_run_no_print(cfg_wami_synth4_3_stm_c, 1);
        esp_run_no_print(cfg_wami_synth4_4_stm_c, 1);
        esp_run_no_print(cfg_wami_synth4_5_stm_c, 1);
    }
    gettime(&t_test_2);
...
{
    cfg_wami_synth4_p2p_a[0].hw_buf = buf;
    cfg_wami_synth4_p2p_a[1].hw_buf = buf;
    cfg_wami_synth4_p2p_a[2].hw_buf = buf;
    cfg_wami_synth4_p2p_a[3].hw_buf = buf;
    cfg_wami_synth4_p2p_a[4].hw_buf = buf;
    cfg_wami_synth4_p2p_a[5].hw_buf = buf;

    struct wami_synth4_stratus_access *tmp;
    for (i = 0; i < 6; i++) {
        tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_a[i].esp_desc;
        tmp->wami_num_img = test_batch;
        tmp->wami_num_col = num_col;
        tmp->wami_num_row = num_row;
        tmp->wami_batch   = delay;
    ...
    gettime(&t_test_1);
    esp_run_no_print(cfg_wami_synth4_p2p_a, 6);
    gettime(&t_test_2);
...
{
    cfg_wami_synth4_p2p_b[0].hw_buf = buf;
    cfg_wami_synth4_p2p_b[1].hw_buf = buf;
    cfg_wami_synth4_p2p_b[2].hw_buf = buf;
    cfg_wami_synth4_p2p_b[3].hw_buf = buf;
    cfg_wami_synth4_p2p_b[4].hw_buf = buf;
    cfg_wami_synth4_p2p_b[5].hw_buf = buf;

    struct wami_synth4_stratus_access *tmp;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_b[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_b[1].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_b[2].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_b[3].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_b[4].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_b[5].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    ...
    gettime(&t_test_1);
    esp_run_no_print(cfg_wami_synth4_p2p_b, 6);
    gettime(&t_test_2);
...
{
    cfg_wami_synth4_p2p_c[0].hw_buf = buf;
    cfg_wami_synth4_p2p_c[1].hw_buf = buf;
    cfg_wami_synth4_p2p_c[2].hw_buf = buf;
    cfg_wami_synth4_p2p_c[3].hw_buf = buf;
    cfg_wami_synth4_p2p_c[4].hw_buf = buf;
    cfg_wami_synth4_p2p_c[5].hw_buf = buf;

    struct wami_synth4_stratus_access *tmp;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_c[0].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_c[1].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row * 2;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_c[2].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col * 2;
    tmp->wami_num_row = num_row * 2;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_c[3].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_c[4].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col * 2;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    tmp               = (struct wami_synth4_stratus_access *)cfg_wami_synth4_p2p_c[5].esp_desc;
    tmp->wami_num_img = test_batch;
    tmp->wami_num_col = num_col;
    tmp->wami_num_row = num_row;
    tmp->wami_batch   = delay;
    ...
    gettime(&t_test_1);
    esp_run_no_print(cfg_wami_synth4_p2p_c, 6);
    gettime(&t_test_2);
...
int main(int argc, char **argv)
{
    printf("-------------------------------------------------------\n");
     if (argc == 3) {
        printf("-- WAMI_SYNTH4 RUN: Start! %s\n", argv[2]);
    } else {
        printf("-- WAMI_SYNTH4 RUN: Start!\n");
    }
    printf("-------------------------------------------------------\n");
    ...
    int qq = 16384;                         // 1073741824;

    if (argc == 1) {
        test_stm_1(buf, 128, 128, qq, 1, "Superman");
    }

    if (argc == 2) {
        qq = atoi(argv[1]);
        printf(" argv[1] = %s\n", argv[1]);
        test_stm_1(buf, 128, 128, qq, 1, "Iron Man");
    }
    ...
    if (argc == 3) {
        ...
        printf(" argv[1] = %s\n", argv[1]);
        printf(" argv[2] = %s\n", argv[2]);
        test_stm_1(buf, 128, 128, qq, 1, argv[2]);
    }

    // test_stm_1(buf, 128, 128, qq, 1);
    // test_stm_2(buf, 128, 128, qq, 1);
    // test_stm_2(buf, 128, 128, 1073741824, 1);
...
CLEANUP:
    ...
    printf("-------------------------------------------------------\n");
    if (argc == 3) {
        printf("-- WAMI_SYNTH4 RUN: FINISH: %s\n", argv[2]);
    } else {
        printf("-- WAMI_SYNTH4 RUN: FINISH\n");
    }
    printf("-------------------------------------------------------\n");
