...
#ifndef __GEMM64_HPP__
#define __GEMM64_HPP__

#include "gemm64_data.hpp"
#include "fpdata.hpp"
#include "gemm64_conf_info.hpp"
#include "gemm64_debug_info.hpp"
#include "esp_templates.hpp"
#include "gemm64_directives.hpp"
#include "common.hpp"

#define __round_mask(x, y) ((y)-1)
#define round_up(x, y) ((((x)-1) | __round_mask(x, y))+1)

class gemm64 : public esp_accelerator_3P<DMA_WIDTH>
{
public:

    // Constructor
    SC_HAS_PROCESS(gemm64);
    gemm64(const sc_module_name& name)
