...
#ifndef _NIGHTHISTEQ_STRATUS_H_
#define _NIGHTHISTEQ_STRATUS_H_
...
struct nightHistEq_stratus_access {
...
#define NIGHTHISTEQ_STRATUS_IOC_ACCESS _IOW('S', 0, struct nightHistEq_stratus_access)

#endif /* _NIGHTHISTEQ_STRATUS_H_ */
