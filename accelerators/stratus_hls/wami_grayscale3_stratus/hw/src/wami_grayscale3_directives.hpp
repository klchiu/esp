...
#ifndef __WAMI_GRAYSCALE3_DIRECTIVES_HPP__
#define __WAMI_GRAYSCALE3_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_plm_A0_debayer   HLS_MAP_TO_MEMORY(plm_A0_debayer, "plm_a0_debayer_128x128")
    #define HLS_MAP_plm_B0_grayscale HLS_MAP_TO_MEMORY(plm_B0_grayscale, "plm_b0_grayscale_128x128")
    ...
    #define HLS_MAP_plm_A0_debayer
    #define HLS_MAP_plm_B0_grayscale
...
#endif /* __WAMI_GRAYSCALE3_DIRECTIVES_HPP_ */
