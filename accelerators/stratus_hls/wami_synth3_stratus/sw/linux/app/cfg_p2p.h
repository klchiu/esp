...
struct wami_synth3_stratus_access wami_synth3_cfg_p2p[] = {
    /* wami_synth3_0 */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
    ...
    /* wami_synth3_1 */
    {
        ...
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
        .esp.p2p_srcs          = {"wami_synth3_stratus.0", "", "", ""},
    },
    /* wami_synth3_2 */
    {
        .src_offset            = 0,
        ...
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
        .esp.p2p_srcs          = {"wami_synth3_stratus.1", "", "", ""},
    },
    /* wami_synth3_3 */
    {
        .src_offset            = 0,
        ...
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
        .esp.p2p_srcs          = {"wami_synth3_stratus.2", "", "", ""},
    },
    /* wami_synth3_4 */
    {
        .src_offset            = 0,
        ...
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
        .esp.p2p_srcs          = {"wami_synth3_stratus.3", "", "", ""},
    },
    /* wami_synth3_5 */
    {
        .src_offset            = 0,
        ...
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
        .esp.p2p_srcs          = {"wami_synth3_stratus.4", "", "", ""},
    },
    /* wami_synth3_6 */
    {
        .src_offset            = 0,
        ...
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
        .esp.p2p_srcs          = {"wami_synth3_stratus.5", "", "", ""},
    },
    /* wami_synth3_7 */
    {
        .src_offset            = 0,
        ...
        .esp.p2p_store         = 0,
        .esp.p2p_nsrcs         = 1,
        .esp.p2p_srcs          = {"wami_synth3_stratus.6", "", "", ""},
    }};

esp_thread_info_t cfg_wami_synth3_p2p[] = {
    /* blank placeholder for formatter */
    {
        .run       = true,
        .devname   = "wami_synth3_stratus.0",
        .ioctl_req = WAMI_SYNTH3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth3_cfg_p2p[0].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth3_stratus.1",
        .ioctl_req = WAMI_SYNTH3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth3_cfg_p2p[1].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth3_stratus.2",
        .ioctl_req = WAMI_SYNTH3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth3_cfg_p2p[2].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth3_stratus.3",
        .ioctl_req = WAMI_SYNTH3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth3_cfg_p2p[3].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth3_stratus.4",
        .ioctl_req = WAMI_SYNTH3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth3_cfg_p2p[4].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth3_stratus.5",
        .ioctl_req = WAMI_SYNTH3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth3_cfg_p2p[5].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth3_stratus.6",
        .ioctl_req = WAMI_SYNTH3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth3_cfg_p2p[6].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth3_stratus.7",
        .ioctl_req = WAMI_SYNTH3_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth3_cfg_p2p[7].esp),
    }};
