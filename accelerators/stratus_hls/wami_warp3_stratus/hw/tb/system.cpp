...
void system_t::config_proc()
{
    ...
    // Config
    {
        ...
        kern_id      = WARP_KERN_ID;
        batch        = 1;
        base_addr_0  = 0;                                                   // use this for output
        base_addr_1  = WAMI_WARP_IMG_NUM_ROWS * WAMI_WARP_IMG_NUM_COLS;     // use this for input image
        base_addr_2  = 3 * WAMI_WARP_IMG_NUM_ROWS * WAMI_WARP_IMG_NUM_COLS; // use this for input matrix[6]
        base_addr_3  = 1;                                                   // reserved
    ...
    // Compute
    {
        ...
        ESP_REPORT_TIME(begin_time, "BEGIN - wami_warp3");
        ...
        ESP_REPORT_TIME(end_time, "END - wami_warp3");
...
void system_t::dump_memory()
{
    ...
    uint32_t mem_base_addr = base_addr_0; // 0
    ...
    write_float_matrix_to_file(warp_iwxp, (srcRows - 2 * PAD), (srcCols - 2 * PAD), "../output/fish_warp_iwxp_out.txt",
                               "Warp IWXP");
