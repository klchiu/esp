...
#ifndef __GEMM128_HPP__
#define __GEMM128_HPP__

#include "gemm128_data.hpp"
#include "fpdata.hpp"
#include "gemm128_conf_info.hpp"
#include "gemm128_debug_info.hpp"
#include "esp_templates.hpp"
#include "gemm128_directives.hpp"
#include "common.hpp"

#define __round_mask(x, y) ((y)-1)
#define round_up(x, y) ((((x)-1) | __round_mask(x, y))+1)

class gemm128 : public esp_accelerator_3P<DMA_WIDTH>
{
public:

    // Constructor
    SC_HAS_PROCESS(gemm128);
    gemm128(const sc_module_name& name)
