...
public:
        ...
        : esp_system<DMA_WIDTH, MEM_SIZE>(name)
    {
        // ACC
#ifdef CADENCE
        acc = new huangemm3s256_wrapper("huangemm3s256_wrapper");
#else
        acc = new huangemm3s256("huangemm3s256_wrapper");
#endif
        // Binding ACC
        acc->clk(clk);
        acc->rst(acc_rst);
