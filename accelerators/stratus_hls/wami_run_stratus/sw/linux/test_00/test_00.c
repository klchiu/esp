 ...
 *
 * gcc -std=gnu99 -O0 -g kthreads.c test_00.c -lpthread -o kthreads
 * sparc-leon3-linux-gcc kthreads.c test_00.c -lpthread -std=c99 -o kthreads
 */

#include "kthreads.h"

#define KERNELS_NUM 4
...
//  for (unsigned i = 0; i < KERNELS_NUM; i++)
