...
#ifndef _NIGHTDWT_STRATUS_H_
#define _NIGHTDWT_STRATUS_H_
...
struct nightDwt_stratus_access {
...
#define NIGHTDWT_STRATUS_IOC_ACCESS _IOW('S', 0, struct nightDwt_stratus_access)

#endif /* _NIGHTDWT_STRATUS_H_ */
