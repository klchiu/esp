...
struct ny_acc_stratus_access ny_acc_cfg_mtm_a[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_ny_acc_0_mtm_a[] = {{
    .run       = true,
    .devname   = "ny_acc_stratus.0",
    .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
    .esp_desc  = &(ny_acc_cfg_mtm_a[0].esp),
}};

esp_thread_info_t cfg_ny_acc_1_mtm_a[] = {{
    .run       = true,
...
esp_thread_info_t cfg_ny_acc_2_mtm_a[] = {{
    .run       = true,
...
esp_thread_info_t cfg_ny_acc_3_mtm_a[] = {{
    .run       = true,
...
esp_thread_info_t cfg_ny_acc_4_mtm_a[] = {{
    .run       = true,
...
esp_thread_info_t cfg_ny_acc_5_mtm_a[] = {{
    .run       = true,
