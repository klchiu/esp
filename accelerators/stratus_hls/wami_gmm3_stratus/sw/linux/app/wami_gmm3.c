...
#include "cfg_wami_gmm3.h"

#define DEVNAME "/dev/wami_gmm3_stratus.0"
#define NAME    "wami_gmm3_stratus"
...
static void init_buf(struct wami_gmm3_test *t)
{
    printf("init buffers\n");
...
int main(int argc, char **argv)
{
    ...
    cfg_wami_gmm3[0].hw_buf = buf;
    
    printf("---- debug 4\n");
    esp_run(cfg_wami_gmm3, 1);
    printf("---- debug 5\n");
    esp_free(buf);
    printf("---- debug 6\n");
