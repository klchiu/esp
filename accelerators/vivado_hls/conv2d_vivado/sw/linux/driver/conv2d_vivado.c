...
static struct of_device_id conv2d_device_ids[] = {
	{
		.name = "SLD_CONV2D_VIVADO",
	},
	{
		.name = "eb_091",
	},
	{
		.compatible = "sld,conv2d_vivado",
	},
	{ },
};
...
static inline struct conv2d_vivado_device *to_conv2d(struct esp_device *esp)
{
	return container_of(esp, struct conv2d_vivado_device, esp);
}

static void conv2d_prep_xfer(struct esp_device *esp, void *arg)
{
	struct conv2d_vivado_access *a = arg;
...
{
	/* struct conv2d_vivado_device *conv2d = to_conv2d(esp); */
	/* struct conv2d_vivado_access *a = arg; */
...
{
	struct conv2d_vivado_device *conv2d;
	struct esp_device *esp;
	int rc;
...
static struct esp_driver conv2d_driver = {
	...
	.ioctl_cm	= CONV2D_VIVADO_IOC_ACCESS,
	.arg_size	= sizeof(struct conv2d_vivado_access),
};
...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("conv2d_vivado driver");
