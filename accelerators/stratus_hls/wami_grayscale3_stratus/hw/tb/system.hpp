...
#ifdef CADENCE
    #include "wami_grayscale3_wrap.h"
#endif
...
class system_t : public esp_system<DMA_WIDTH, MEM_SIZE>
{
  public:
        ...
        : esp_system<DMA_WIDTH, MEM_SIZE>(name)
    {
        // ACC
#ifdef CADENCE
        acc = new wami_grayscale3_wrapper("wami_grayscale3_wrapper");
#else
        acc = new wami_grayscale3("wami_grayscale3_wrapper");
#endif
        // Binding ACC
        acc->clk(clk);
        acc->rst(acc_rst);
