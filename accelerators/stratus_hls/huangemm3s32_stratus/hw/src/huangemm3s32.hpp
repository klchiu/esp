...
#ifndef __HUANGEMM3S32_HPP__
#define __HUANGEMM3S32_HPP__

#include "huangemm3s32_conf_info.hpp"
#include "huangemm3s32_debug_info.hpp"

#include "esp_templates.hpp"

#include "huangemm3s32_directives.hpp"
...
#define PLM_OUT_WORD 32
// #define PLM_IN_WORD 326782
#define PLM_IN_WORD 32

class huangemm3s32 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(huangemm3s32);
    huangemm3s32(const sc_module_name& name)
