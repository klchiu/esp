...
void system_t::init_arrays(int len)
{
    ...
    for (i = 0 ; i < len; i++){
        float val_1 = (i%(2 << (FPDATA_IL-8))) *100 / 3.0 - 17;
        float val_2 = (i%(2 << (FPDATA_IL-8))) *100 / 9.0 - 17;
...
void system_t::config_proc()
{
    ...
    // Compute
    {
        ...
        ESP_REPORT_TIME(begin_time, "BEGIN - tf_sub3");
        ...
        ESP_REPORT_TIME(end_time, "END - tf_sub3");
