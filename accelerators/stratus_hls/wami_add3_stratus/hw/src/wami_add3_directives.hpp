...
#ifndef __WAMI_ADD3_DIRECTIVES_HPP__
#define __WAMI_ADD3_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_A0_affine_params HLS_MAP_TO_MEMORY(A0_affine_params, "plm_add_6")
    #define HLS_MAP_A0_sd_delta_p    HLS_MAP_TO_MEMORY(A0_sd_delta_p, "plm_add_6")
    #define HLS_MAP_B0_affine_params HLS_MAP_TO_MEMORY(B0_affine_params, "plm_add_6")
...
#endif /* __WAMI_ADD3_DIRECTIVES_HPP_ */
