...
struct ny_acc_stratus_access ny_acc_cfg_p2p_b[] = {
    /* ny_acc_0 */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
    ...
    /* ny_acc_1 */
    {
        ...
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 2,
        .esp.p2p_srcs          = {"ny_acc_stratus.4", "ny_acc_stratus.0", "", ""},
    },
    /* ny_acc_2 */
    {
        .src_offset            = 0,
...
esp_thread_info_t cfg_ny_acc_p2p_b[] = {
    /* blank placeholder for formatter */
    {
        ...
        .esp_desc  = &(ny_acc_cfg_p2p_b[4].esp),
    },
    {
        .run       = true,
        .devname   = "ny_acc_stratus.0",
        .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
        .esp_desc  = &(ny_acc_cfg_p2p_b[0].esp),
    },
    {
        .run       = true,
        .devname   = "ny_acc_stratus.1",
        .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
        .esp_desc  = &(ny_acc_cfg_p2p_b[1].esp),
    },
    {
        .run       = true,
        .devname   = "ny_acc_stratus.2",
        .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
        .esp_desc  = &(ny_acc_cfg_p2p_b[2].esp),
    },
    {
        .run       = true,
        .devname   = "ny_acc_stratus.3",
        .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
        .esp_desc  = &(ny_acc_cfg_p2p_b[3].esp),
    },
    {
        .run       = true,
        .devname   = "ny_acc_stratus.5",
        .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
        .esp_desc  = &(ny_acc_cfg_p2p_b[5].esp),
    }};
