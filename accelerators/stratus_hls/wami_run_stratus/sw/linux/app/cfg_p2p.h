...
struct wami_run_stratus_access wami_debayer3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
struct wami_run_stratus_access wami_grayscale3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
        ...
        .wami_src_dst_offset_4 = 0,
        .wami_is_p2p           = 1,
        .wami_p2p_config_0     = 3, // num_output_copy
        .wami_p2p_config_1     = 0,
        .esp.coherence         = ACC_COH_NONE,
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
...
struct wami_run_stratus_access wami_gradient3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
        ...
        .wami_src_dst_offset_4 = 0,
        .wami_is_p2p           = 1,
        .wami_p2p_config_0     = 2, // num_output_copy
        .wami_p2p_config_1     = 0, // is_dummy
        .esp.coherence         = ACC_COH_NONE,
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
...
struct wami_run_stratus_access wami_warp_img3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
        ...
        .wami_src_dst_offset_4 = 0,
        .wami_is_p2p           = 1,
        .wami_p2p_config_0     = 0, // warp_no: 0: warp-img, 1: warp-dx, 2: warp-dy, 3: warp-iwxp
        .wami_p2p_config_1     = 0, // iwxp_temp
        .esp.coherence         = ACC_COH_NONE,
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 2,
        .esp.p2p_srcs          = {"wami_add3_stratus.0", "wami_grayscale3_stratus.0", "", ""},
    }};

struct wami_run_stratus_access wami_sub3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
struct wami_run_stratus_access wami_warp_x3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
        ...
        .wami_src_dst_offset_4 = 0,
        .wami_is_p2p           = 1,
        .wami_p2p_config_0     = 1, // warp_no: 0: warp-img, 1: warp-dx, 2: warp-dy, 3: warp-iwxp
        .wami_p2p_config_1     = 0, // iwxp_temp
        .esp.coherence         = ACC_COH_NONE,
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 2,
        .esp.p2p_srcs          = {"wami_add3_stratus.0", "wami_gradient3_stratus.0", "", ""},
    }};

struct wami_run_stratus_access wami_warp_y3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
        ...
        .wami_src_dst_offset_4 = 0,
        .wami_is_p2p           = 1,
        .wami_p2p_config_0     = 2, // warp_no: 0: warp-img, 1: warp-dx, 2: warp-dy, 3: warp-iwxp
        .wami_p2p_config_1     = 0, // iwxp_temp
        .esp.coherence         = ACC_COH_NONE,
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 2,
...
struct wami_run_stratus_access wami_steep_descent3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
struct wami_run_stratus_access wami_hessian3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
struct wami_run_stratus_access wami_inv3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
struct wami_run_stratus_access wami_sd_update3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
struct wami_run_stratus_access wami_mult3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
struct wami_run_stratus_access wami_reshape3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
        ...
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
        .esp.p2p_srcs          = {"wami_mult3_stratus.0", "", "", ""},
    }};

struct wami_run_stratus_access wami_add3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
        ...
        .wami_p2p_config_1     = 3, // num_backward_pass
        .esp.coherence         = ACC_COH_NONE,
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
...
struct wami_run_stratus_access wami_warp_iwxp3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
        ...
        .wami_src_dst_offset_4 = 0,
        .wami_is_p2p           = 1,
        .wami_p2p_config_0     = 3,             // warp_no: 0: warp-img, 1: warp-dx, 2: warp-dy, 3: warp-iwxp
        .wami_p2p_config_1     = (1 << 16) + 1, // iwxp_temp
        .esp.coherence         = ACC_COH_NONE,
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 2,
        .esp.p2p_srcs          = {"wami_add3_stratus.0", "wami_grayscale3_stratus.0", "", ""},
...
struct wami_run_stratus_access wami_gradient3_dummy_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
struct wami_run_stratus_access wami_gmm3_cfg_p2p[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
