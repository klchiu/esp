...
#define SLD_SYSTOLIC_GEMM3 0x083
#define DEV_NAME "sld,systolic_gemm3_vivado"
...
int main(int argc, char * argv[])
{
	...
	ndev = probe(&espdevs, VENDOR_SLD, SLD_SYSTOLIC_GEMM3, DEV_NAME);
	if (ndev == 0) {
		printf("systolic_gemm3 not found\n");
		return 0;
	}
