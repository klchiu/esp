...
#ifndef __CFG_WAMI_SD_UPDATE3_H__
#define __CFG_WAMI_SD_UPDATE3_H__
...
struct wami_sd_update3_stratus_access wami_sd_update3_cfg[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_wami_sd_update3[] = {{
    .run       = true,
    .devname   = "wami_sd_update3_stratus.0",
    .ioctl_req = WAMI_SD_UPDATE3_STRATUS_IOC_ACCESS,
    .esp_desc  = &(wami_sd_update3_cfg[0].esp),
}};

#endif /* __CFG_WAMI_SD_UPDATE3_H__ */
