...
static long long sw_run(int32_t n_channels, int32_t feature_map_height, int32_t feature_map_width,
...
int main(int argc, char **argv)
{
    ...
    int32_t n_channels_3[5] = {8, 16, 32, 64, 128};
    int32_t n_channels = 100;
    // int32_t feature_map_height_3[8] = {8, 16, 32, 64, 128, 256, 512, 1024};
    int32_t feature_map_height_3[5] = {8, 16, 32, 64, 128};
        ...
        for (i = 0; i < 5; i++)
        {
            ...
            for (j = 0; j < 5; j++)
            {
                ...
                init_parameters(test,
                                n_channels, feature_map_height, feature_map_width,
                ...
                fprintf(log_0323, "filter_dim: %d n_channels: %d feature_map_height: %d hw_ns: %llu sw_ns: %llu no_error: %d\n", filter_dim, n_channels, feature_map_height, hw_ns, sw_ns, no_error);
            }
        }
    }
