...
#ifndef __WAMI_DEBAYER3_DIRECTIVES_HPP__
#define __WAMI_DEBAYER3_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_A0_bayer   HLS_MAP_TO_MEMORY(A0_bayer, "plm_A0_bayer_132x132")
    #define HLS_MAP_B0_debayer HLS_MAP_TO_MEMORY(B0_debayer, "plm_B0_debayer_128x128")
    ...
    #define HLS_MAP_A0_bayer
    #define HLS_MAP_B0_debayer
...
#endif /* __WAMI_DEBAYER3_DIRECTIVES_HPP_ */
