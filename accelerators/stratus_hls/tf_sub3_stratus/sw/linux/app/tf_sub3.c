...
#define DEVNAME "/dev/tf_sub3_stratus.0"
#define NAME    "tf_sub3_stratus"
...
static void init_buf(struct tf_sub3_test *t)
{
    printf("init buffers\n");
