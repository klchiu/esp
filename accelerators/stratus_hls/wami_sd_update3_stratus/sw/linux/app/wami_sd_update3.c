...
#include "cfg_wami_sd_update3.h"

#define DEVNAME "/dev/wami_sd_update3_stratus.0"
#define NAME    "wami_sd_update3_stratus"
...
static void init_buf(struct wami_sd_update3_test *t)
{
    printf("init buffers\n");
...
{
    printf("=== Helloo from wami_sd_update3\n");
    ...
    cfg_wami_sd_update3[0].hw_buf = buf;
    
    printf("---- debug 4\n");
    esp_run(cfg_wami_sd_update3, 1);
    printf("---- debug 5\n");
    esp_free(buf);
    printf("---- debug 6\n");
