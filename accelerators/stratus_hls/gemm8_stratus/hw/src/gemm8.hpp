...
#ifndef __GEMM8_HPP__
#define __GEMM8_HPP__

#include "gemm8_data.hpp"
#include "fpdata.hpp"
#include "gemm8_conf_info.hpp"
#include "gemm8_debug_info.hpp"
#include "esp_templates.hpp"
#include "gemm8_directives.hpp"
#include "common.hpp"

#define __round_mask(x, y) ((y)-1)
#define round_up(x, y) ((((x)-1) | __round_mask(x, y))+1)

class gemm8 : public esp_accelerator_3P<DMA_WIDTH>
{
public:

    // Constructor
    SC_HAS_PROCESS(gemm8);
    gemm8(const sc_module_name& name)
