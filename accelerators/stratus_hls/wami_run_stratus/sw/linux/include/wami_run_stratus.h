...
#ifndef _WAMI_RUN_STRATUS_H_
#define _WAMI_RUN_STRATUS_H_
...
struct wami_run_stratus_access {
...
#define WAMI_RUN_STRATUS_IOC_ACCESS                   _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_DEBAYER3_STRATUS_IOC_ACCESS              _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_GRAYSCALE3_STRATUS_IOC_ACCESS            _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_GRADIENT3_STRATUS_IOC_ACCESS             _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_WARP_IMG3_STRATUS_IOC_ACCESS             _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_SUB3_STRATUS_IOC_ACCESS                  _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_WARP_X3_STRATUS_IOC_ACCESS               _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_WARP_Y3_STRATUS_IOC_ACCESS               _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_STEEP_DESCENT3_STRATUS_IOC_ACCESS        _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_HESSIAN3_STRATUS_IOC_ACCESS              _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_INV3_STRATUS_IOC_ACCESS                  _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_SD_UPDATE3_STRATUS_IOC_ACCESS            _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_MULT3_STRATUS_IOC_ACCESS                 _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_RESHAPE3_STRATUS_IOC_ACCESS              _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_ADD3_STRATUS_IOC_ACCESS                  _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_WARP_IWXP3_STRATUS_IOC_ACCESS            _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_GMM3_STRATUS_IOC_ACCESS                  _IOW('S', 0, struct wami_run_stratus_access)

#define WAMI_RESHAPE_ADD_STRATUS_IOC_ACCESS           _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_HESSIAN_INV_STRATUS_IOC_ACCESS           _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_STEEP_DESCENT_HESSIAN_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_MULT_RESHAPE_ADD_STRATUS_IOC_ACCESS      _IOW('S', 0, struct wami_run_stratus_access)
#define WAMI_WARP_XY_STRATUS_IOC_ACCESS      _IOW('S', 0, struct wami_run_stratus_access)

FILE *log_file_pv;
FILE *log_file;
FILE *log_file_combo1;
FILE *log_file_combo2;
FILE *log_file_combo3;
FILE *log_file_combo4;
...
struct timespec t_test_indep_mem_real_batch_1, t_test_indep_mem_real_batch_2;
struct timespec t_test_indep_mem_batch_1, t_test_indep_mem_batch_2;
struct timespec t_test_shared_mem_1, t_test_shared_mem_2;
struct timespec t_test_p2p_1, t_test_p2p_2;
struct timespec t_test_multi_thread_1, t_test_multi_thread_2;
struct timespec t_test_app_level_speedup_1, t_test_app_level_speedup_2;
...
struct timespec t_reshape_add_1, t_reshape_add_2;
struct timespec t_mult_reshape_add_1, t_mult_reshape_add_2;
struct timespec t_hessian_inv_1, t_hessian_inv_2;
struct timespec t_steep_descent_hessian_1, t_steep_descent_hessian_2;
struct timespec t_gmm_1, t_gmm_2;
