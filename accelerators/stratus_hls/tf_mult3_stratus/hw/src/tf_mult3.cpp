...
#include "tf_mult3_directives.hpp"


// Functions

#include "tf_mult3_functions.hpp"

// Processes

void tf_mult3::load_input()
{
    ...
    // Load
        ...
        ESP_REPORT_TIME(load_begin_time, "LOAD BEGIN - tf_mult3");
#endif
        ...
        for(uint32_t c = 0; c < mem_length; c+=chunk_size){
            ...
            ESP_REPORT_TIME(load_end_time, "LOAD END - tf_mult3");
#endif
...
void tf_mult3::store_output()
{
    ...
    // Config
    {
        ...
        ESP_REPORT_TIME(store_begin_time, "STORE BEGIN - tf_mult3");
#endif
        ...
        ESP_REPORT_TIME(store_end_time, "STORE END - tf_mult3");
#endif
...
void tf_mult3::compute_kernel()
{
    ...
    // Compute
        ...
        ESP_REPORT_TIME(compute_begin_time, "COMPUTE BEGIN - tf_mult3");
#endif
        ...
        ESP_REPORT_TIME(compute_end_time, "COMPUTE END - tf_mult3");
#endif
