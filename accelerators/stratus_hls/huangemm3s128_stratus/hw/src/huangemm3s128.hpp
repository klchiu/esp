...
#ifndef __HUANGEMM3S128_HPP__
#define __HUANGEMM3S128_HPP__

#include "huangemm3s128_conf_info.hpp"
#include "huangemm3s128_debug_info.hpp"

#include "esp_templates.hpp"

#include "huangemm3s128_directives.hpp"
...
class huangemm3s128 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(huangemm3s128);
    huangemm3s128(const sc_module_name& name)
