...
struct gemmenough8_stratus_access gemmenough8_cfg_000[] = {
	{
		/* <<--descriptor-->> */
		.ninputs = NINPUTS,
		.d3 = D3,
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "gemmenough8_stratus.0",
		.ioctl_req = GEMMENOUGH8_STRATUS_IOC_ACCESS,
		.esp_desc = &(gemmenough8_cfg_000[0].esp),
	}
};
