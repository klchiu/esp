...
#ifndef __TF_MULT3_HPP__
#define __TF_MULT3_HPP__

#include "fpdata.hpp"


#include "tf_mult3_conf_info.hpp"
#include "tf_mult3_debug_info.hpp"
...
class tf_mult3 : public esp_accelerator_3P<DMA_WIDTH>
{
  public:
    // Output <-> Input
    ...
    // Constructor
    SC_HAS_PROCESS(tf_mult3);
    tf_mult3(const sc_module_name &name)
...
inline void tf_mult3::store_load_handshake()
{
    {
...
inline void tf_mult3::load_store_handshake()
{
    {
