...
#ifndef __NIGHTNF_FUNCTIONS_HPP__
#define __NIGHTNF_FUNCTIONS_HPP__
...
void nightNF::kernel_nf(uint32_t n_Rows, uint32_t n_Cols)
{
...
void nightNF::kernel_histEq(uint32_t n_Rows, uint32_t n_Cols)
{
...
void nightNF::kernel_dwt(uint32_t n_Rows, uint32_t n_Cols)
{
...
void nightNF::dwt_row_transpose(uint32_t n_Rows, uint32_t n_Cols, int16_t buff1[PLM_IMG_SIZE],
