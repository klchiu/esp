...
#ifndef __GEMMBIG_HPP__
#define __GEMMBIG_HPP__

#include "gemmBig_data.hpp"
#include "fpdata.hpp"
#include "gemmBig_conf_info.hpp"
#include "gemmBig_debug_info.hpp"
#include "esp_templates.hpp"
#include "gemmBig_directives.hpp"
#include "common.hpp"

#define __round_mask(x, y) ((y)-1)
#define round_up(x, y) ((((x)-1) | __round_mask(x, y))+1)

class gemmBig : public esp_accelerator_3P<DMA_WIDTH>
{
public:

    // Constructor
    SC_HAS_PROCESS(gemmBig);
    gemmBig(const sc_module_name& name)
