...
#ifndef __NIGHTHIST_FUNCTIONS_HPP__
#define __NIGHTHIST_FUNCTIONS_HPP__

#include "nightHist.hpp"

// Optional application-specific helper functions
#define MIN(A, B) (A < B) ? A : B
#define MAX(A, B) (A > B) ? A : B
/*
void nightHist::kernel_nf(uint32_t n_Rows, uint32_t n_Cols)
{
...
*/
void nightHist::kernel_hist(uint32_t n_Rows, uint32_t n_Cols)
{
...
/*
void nightHist::kernel_histEq(uint32_t n_Rows, uint32_t n_Cols)
{
...
void nightHist::kernel_dwt(uint32_t n_Rows, uint32_t n_Cols)
{
...
void nightHist::dwt_row_transpose(uint32_t n_Rows, uint32_t n_Cols, int16_t buff1[PLM_IMG_SIZE],
...
*/
#endif // __NIGHTHIST_FUNCTIONS_HPP__
