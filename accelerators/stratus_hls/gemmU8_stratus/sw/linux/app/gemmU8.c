                            ...
                            unsigned *out_size, unsigned *size)
{
    ...
    *size     = *in_size + *out_size;
    ...
    gemmU8_cfg_000[0].do_relu    = do_relu;
    gemmU8_cfg_000[0].transpose  = transpose;
    gemmU8_cfg_000[0].ninputs    = ninputs;
    gemmU8_cfg_000[0].d1         = d1;
    gemmU8_cfg_000[0].d2         = d2;
    gemmU8_cfg_000[0].d3         = d3;
    gemmU8_cfg_000[0].ld_offset1 = ld_offset1;
    gemmU8_cfg_000[0].ld_offset2 = ld_offset2;
    gemmU8_cfg_000[0].st_offset  = st_offset;
