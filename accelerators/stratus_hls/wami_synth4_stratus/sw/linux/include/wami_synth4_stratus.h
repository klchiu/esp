...
#ifndef _WAMI_SYNTH4_STRATUS_H_
#define _WAMI_SYNTH4_STRATUS_H_
...
struct wami_synth4_stratus_access {
...
#define WAMI_SYNTH4_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_synth4_stratus_access)
