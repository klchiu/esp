...
struct gemmenough64_stratus_access gemmenough64_cfg_000[] = {
	{
		/* <<--descriptor-->> */
		.ninputs = NINPUTS,
		.d3 = D3,
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "gemmenough64_stratus.0",
		.ioctl_req = GEMMENOUGH64_STRATUS_IOC_ACCESS,
		.esp_desc = &(gemmenough64_cfg_000[0].esp),
	}
};
