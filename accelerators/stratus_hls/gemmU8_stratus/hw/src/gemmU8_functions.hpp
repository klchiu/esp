...
inline void gemmU8::calculate_config(uint24_t ninputs, uint24_t matrix_d1, uint24_t matrix_d2, uint24_t matrix_d3,
...
inline void gemmU8::calculate_chunks(uint24_t &matrix_chk, uint16_t &matrix_rem, uint32_t matrix_d2, bool in_or_out)
{
    uint32_t matrix_mul;
    {
...
inline void gemmU8::sync_compute_store(uint16_t &count, uint16_t loaded_rows, uint8_t load_cfg, uint16_t loadable_rows,
                                       bool &pingpong)
{
    count++;
...
inline void gemmU8::load_compute_cfg_handshake()
{
...
inline void gemmU8::compute_load_cfg_handshake()
{
...
inline void gemmU8::load_store_cfg_handshake()
{
...
inline void gemmU8::store_load_cfg_handshake()
{
