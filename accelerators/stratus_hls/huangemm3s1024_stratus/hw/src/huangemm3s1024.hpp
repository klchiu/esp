...
#ifndef __HUANGEMM3S1024_HPP__
#define __HUANGEMM3S1024_HPP__

#include "huangemm3s1024_conf_info.hpp"
#include "huangemm3s1024_debug_info.hpp"

#include "esp_templates.hpp"

#include "huangemm3s1024_directives.hpp"
...
class huangemm3s1024 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(huangemm3s1024);
    huangemm3s1024(const sc_module_name& name)
        ...
        , cfg("config")
    {
        ...
        HLS_MAP_plm(O_pong, PLM_IN_NAME);
        HLS_MAP_plm(O_ping, PLM_IN_NAME);
