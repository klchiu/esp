...
struct ny_acc_stratus_access ny_acc_cfg_p2p_a[] = {
    /* ny_acc_0 */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_ny_acc_p2p_a[] = {
    /* blank placeholder for formatter */
    {
        .run       = true,
        .devname   = "ny_acc_stratus.0",
        .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
        .esp_desc  = &(ny_acc_cfg_p2p_a[0].esp),
    },
    {
        .run       = true,
        .devname   = "ny_acc_stratus.1",
        .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
        .esp_desc  = &(ny_acc_cfg_p2p_a[1].esp),
    },
    {
        .run       = true,
        .devname   = "ny_acc_stratus.2",
        .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
        .esp_desc  = &(ny_acc_cfg_p2p_a[2].esp),
    },
    {
        .run       = true,
        .devname   = "ny_acc_stratus.3",
        .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
        .esp_desc  = &(ny_acc_cfg_p2p_a[3].esp),
    },
    {
        .run       = true,
        .devname   = "ny_acc_stratus.4",
        .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
        .esp_desc  = &(ny_acc_cfg_p2p_a[4].esp),
    },
    {
        .run       = true,
        .devname   = "ny_acc_stratus.5",
        .ioctl_req = NY_ACC_STRATUS_IOC_ACCESS,
        .esp_desc  = &(ny_acc_cfg_p2p_a[5].esp),
    }};
