...
#ifndef __GEMMENOUGH128_HPP__
#define __GEMMENOUGH128_HPP__
...
class gemmenough128 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(gemmenough128);
    gemmenough128(const sc_module_name& name)
