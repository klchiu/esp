...
#ifndef __NIGHTHISTEQ_HPP__
#define __NIGHTHISTEQ_HPP__

#include "nightHistEq_conf_info.hpp"
#include "nightHistEq_debug_info.hpp"
...
class nightHistEq : public esp_accelerator_3P<DMA_WIDTH>
{
  public:
    // Output <-> Input
    ...
    // Constructor
    SC_HAS_PROCESS(nightHistEq);
    nightHistEq(const sc_module_name &name)
...
inline void nightHistEq::store_load_handshake()
{
    {
...
inline void nightHistEq::load_store_handshake()
{
    {
