...
#ifndef __NIGHTDWT_FUNCTIONS_HPP__
#define __NIGHTDWT_FUNCTIONS_HPP__

#include "nightDwt.hpp"
...
void nightDwt::kernel_hist(uint32_t n_Rows, uint32_t n_Cols)
{
...
void nightDwt::kernel_histEq(uint32_t n_Rows, uint32_t n_Cols)
{
...
void nightDwt::dwt_row_transpose(uint32_t n_Rows, uint32_t n_Cols, int16_t buff1[PLM_IMG_SIZE],
...
#endif // __NIGHTDWT_FUNCTIONS_HPP__
