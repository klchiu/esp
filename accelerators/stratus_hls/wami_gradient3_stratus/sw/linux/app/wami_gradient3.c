...
#include "cfg_wami_gradient3.h"

#define DEVNAME "/dev/wami_gradient3_stratus.0"
#define NAME    "wami_gradient3_stratus"
...
static void init_buf(struct wami_gradient3_test *t)
{
    printf("init buffers\n");
...
{
    printf("=== Helloo from wami_gradient3\n");
    ...
    cfg_wami_gradient3[0].hw_buf = buf;
    
    printf("---- debug 4\n");
    esp_run(cfg_wami_gradient3, 1);
    printf("---- debug 5\n");
    esp_free(buf);
    printf("---- debug 6\n");
