...
#ifndef __WAMI_HESSIAN_INV_DIRECTIVES_HPP__
#define __WAMI_HESSIAN_INV_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_A0_steepest_descent HLS_MAP_TO_MEMORY(A0_steepest_descent, "plm_a0b0_6x16384")
    #define HLS_MAP_B0_hess             HLS_MAP_TO_MEMORY(B0_hess, "plm_a0b0_36 ")

    #define HLS_MAP_A0_hess      HLS_MAP_TO_MEMORY(A0_hess, "plm_a0b0_36")
    #define HLS_MAP_B0_hess_inv  HLS_MAP_TO_MEMORY(B0_hess_inv, "plm_a0b0_36")
    #define HLS_MAP_C0_workspace HLS_MAP_TO_MEMORY(C0_workspace, "plm_a0b0_36")
    ...
    #define HLS_MAP_A0_hess
    #define HLS_MAP_B0_hess_inv
    #define HLS_MAP_C0_workspace
...
#endif /* __WAMI_HESSIAN_INV_DIRECTIVES_HPP_ */
