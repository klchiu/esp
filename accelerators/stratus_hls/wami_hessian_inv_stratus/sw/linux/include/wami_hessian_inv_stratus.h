...
#ifndef _WAMI_HESSIAN_INV_STRATUS_H_
#define _WAMI_HESSIAN_INV_STRATUS_H_
...
struct wami_hessian_inv_stratus_access {
...
#define WAMI_HESSIAN_INV_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_hessian_inv_stratus_access)

#endif /* _WAMI_HESSIAN_INV_STRATUS_H_ */
