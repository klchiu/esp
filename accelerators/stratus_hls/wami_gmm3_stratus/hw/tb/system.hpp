...
class system_t : public esp_system<DMA_WIDTH, MEM_SIZE>
{
  public:
        ...
        : esp_system<DMA_WIDTH, MEM_SIZE>(name)
    {
        // ACC
#ifdef CADENCE
        acc = new wami_gmm3_wrapper("wami_gmm3_wrapper");
#else
        acc = new wami_gmm3("wami_gmm3_wrapper");
#endif
        // Binding ACC
        acc->clk(clk);
        acc->rst(acc_rst);
    ...
    uint16_t *   golden_gmm_img;        // int version of golden_warp_iwxp, input of change_detection
