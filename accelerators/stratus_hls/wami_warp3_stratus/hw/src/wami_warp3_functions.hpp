...
#ifndef __WAMI_WARP3_FUNCTIONS_HPP__
#define __WAMI_WARP3_FUNCTIONS_HPP__
...
// floor function
FPDATA wami_warp3::floor(FPDATA pixel_fp)
{
...
FPDATA wami_warp3::interpolate(FPDATA Tlocalx, FPDATA Tlocaly, int nCols, int nRows)
{
...
void wami_warp3::warp_image(uint32_t nCols, uint32_t nRows)
{
    int    x, y;
...
#endif // __WAMI_WARP3_FUNCTIONS_HPP__
