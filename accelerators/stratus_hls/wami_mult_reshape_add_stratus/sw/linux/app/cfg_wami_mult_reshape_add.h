...
#ifndef __CFG_WAMI_MULT_RESHAPE_ADD_H__
#define __CFG_WAMI_MULT_RESHAPE_ADD_H__
...
struct wami_mult_reshape_add_stratus_access wami_mult_reshape_add_cfg[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_wami_mult_reshape_add[] = {{
    .run       = true,
    .devname   = "wami_mult_reshape_add_stratus.0",
    .ioctl_req = WAMI_MULT_RESHAPE_ADD_STRATUS_IOC_ACCESS,
    .esp_desc  = &(wami_mult_reshape_add_cfg[0].esp),
}};

#endif /* __CFG_WAMI_MULT_RESHAPE_ADD_H__ */
