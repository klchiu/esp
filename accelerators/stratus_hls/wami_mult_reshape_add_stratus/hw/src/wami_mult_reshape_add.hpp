...
#ifndef __WAMI_MULT_RESHAPE_ADD_HPP__
#define __WAMI_MULT_RESHAPE_ADD_HPP__

// #include "wami_mult_reshape_add_data.hpp"
#include "fpdata.hpp"
...
#include "wami_mult_reshape_add_debug_info.hpp"

#include "esp_templates.hpp"

#include "wami_mult_reshape_add_directives.hpp"

#include "utils/esp_handshake.hpp"

class wami_mult_reshape_add : public esp_accelerator_3P<DMA_WIDTH>
{
  public:
    // Output <-> Input
    ...
    // Constructor
    SC_HAS_PROCESS(wami_mult_reshape_add);
    wami_mult_reshape_add(const sc_module_name &name)
    ...
    // , next_image("next_image")
    {
        ...
        HLS_MAP_A0B0_delta_p;
        HLS_MAP_A0B0_sd_delta_p;
    ...
    // Configure wami_mult_reshape_add
    esp_config_proc cfg;
    ...
    FPDATA_WORD A0B0_delta_p[6]; // [humu]: shouldn't be 6 only???

    // FPDATA_WORD A0_delta_p[6];
    FPDATA_WORD A0B0_sd_delta_p[6];
...
inline void wami_mult_reshape_add::store_load_handshake()
{
    {
...
inline void wami_mult_reshape_add::load_store_handshake()
{
    {
...
#endif /* __WAMI_MULT_RESHAPE_ADD_HPP__ */
