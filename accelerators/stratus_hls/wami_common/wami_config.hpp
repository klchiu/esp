#ifndef _WAMI_CONFIG_HPP_
#define _WAMI_CONFIG_HPP_
...
#define NUM_IMGS 1 // [humu]: Use 1 for now
// #define NUM_IMGS 17
#define NUM_ROWS 132
#define NUM_COLS 132
...
#define WAMI_GRAYSCALE_IMG_NUM_IMGS NUM_IMGS
#define WAMI_GRAYSCALE_IMG_NUM_ROWS (WAMI_DEBAYER_IMG_NUM_ROWS - (2 * PAD))
#define WAMI_GRAYSCALE_IMG_NUM_COLS (WAMI_DEBAYER_IMG_NUM_COLS - (2 * PAD))
...
#define SYNTH_KERN_ID               14

#endif /* _WAMI_CONFIG_HPP_ */
