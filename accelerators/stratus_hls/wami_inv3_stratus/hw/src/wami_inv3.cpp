...
#include "wami_inv3_functions.hpp"

// Processes

void wami_inv3::load_input()
{
    ...
    for (uint32_t img = 0; img < img_num_img; img++) {
        ...
        if (mem_src_dst_offset_4 == 1) {
            // [humu]: for p2p combo3 (this is wrong)
