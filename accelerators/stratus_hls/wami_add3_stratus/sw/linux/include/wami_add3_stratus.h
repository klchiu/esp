...
#ifndef _WAMI_ADD3_STRATUS_H_
#define _WAMI_ADD3_STRATUS_H_
...
struct wami_add3_stratus_access {
...
#define WAMI_ADD3_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_add3_stratus_access)

#endif /* _WAMI_ADD3_STRATUS_H_ */
