...
#define DEVNAME "/dev/tf_add3_stratus.0"
#define NAME    "tf_add3_stratus"
...
static void init_buf(struct tf_add3_test *t)
{
    printf("init buffers\n");
