...
#include "cfg_wami_reshape_add.h"

#define DEVNAME "/dev/wami_reshape_add_stratus.0"
#define NAME    "wami_reshape_add_stratus"
...
static void init_buf(struct wami_reshape_add_test *t)
{
    printf("init buffers\n");
...
{
    printf("=== Helloo from wami_reshape_add\n");
    ...
    cfg_wami_reshape_add[0].hw_buf = buf;
    
    printf("---- debug 4\n");
    esp_run(cfg_wami_reshape_add, 1);
    printf("---- debug 5\n");
    esp_free(buf);
    printf("---- debug 6\n");
