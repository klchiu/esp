...
#ifndef __GEMMENOUGH32_HPP__
#define __GEMMENOUGH32_HPP__

#include "gemmenough32_conf_info.hpp"
#include "gemmenough32_debug_info.hpp"
...
class gemmenough32 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(gemmenough32);
    gemmenough32(const sc_module_name& name)
