...
#ifndef __WAMI_WARP_XY_DIRECTIVES_HPP__
#define __WAMI_WARP_XY_DIRECTIVES_HPP__
...
typedef sc_uint<16> pixel_t;
    ...
    #define HLS_MAP_A0_W_xp HLS_MAP_TO_MEMORY(A0_W_xp, "plm_a0b0_add_6")
    #define HLS_MAP_A0_img  HLS_MAP_TO_MEMORY(A0_img, "plm_a0b0_warp_128x128")
    #define HLS_MAP_B0_img  HLS_MAP_TO_MEMORY(B0_img, "plm_a0b0_warp_128x128")
   ...
   #define HLS_MAP_A0_W_xp 
    #define HLS_MAP_A0_img 
    #define HLS_MAP_B0_img 
...
#endif /* __WAMI_WARP_XY_DIRECTIVES_HPP_ */
