...
void system_t::config_proc()
{
    ...
    // Config
    {
        ...
        base_addr_2  = base_addr_1 + 6; // use this for input 2
    ...
    // Compute
    {
        ...
        ESP_REPORT_TIME(begin_time, "BEGIN - wami_add3");
        ...
        ESP_REPORT_TIME(end_time, "END - wami_add3");
...
void system_t::load_memory()
{
    ...
    for (uint32_t index = 0; index < 6; index++) {
        ...
        // convert float to fx
        data_fp = FPDATA(golden_sd_delta_p_nxt[index]);
        // convert fx to bv
