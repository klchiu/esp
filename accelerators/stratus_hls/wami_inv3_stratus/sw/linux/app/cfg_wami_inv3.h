...
#ifndef __CFG_WAMI_INV3_H__
#define __CFG_WAMI_INV3_H__
...
struct wami_inv3_stratus_access wami_inv3_cfg[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_wami_inv3[] = {{
    .run       = true,
    .devname   = "wami_inv3_stratus.0",
    .ioctl_req = WAMI_INV3_STRATUS_IOC_ACCESS,
    .esp_desc  = &(wami_inv3_cfg[0].esp),
}};

#endif /* __CFG_WAMI_INV3_H__ */
