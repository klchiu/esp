...
class tf_add3 : public esp_accelerator_3P<DMA_WIDTH>
{
  public:
    ...
    // Constructor
    SC_HAS_PROCESS(tf_add3);
    tf_add3(const sc_module_name &name)
...
inline void tf_add3::store_load_handshake()
{
    {
...
inline void tf_add3::load_store_handshake()
{
    {
