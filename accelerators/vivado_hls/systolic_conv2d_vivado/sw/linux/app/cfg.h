...
struct systolic_conv2d_vivado_access systolic_conv2d_cfg_000[] = {
	{
		/* <<--descriptor-->> */
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "systolic_conv2d_vivado.0",
		.ioctl_req = SYSTOLIC_CONV2D_VIVADO_IOC_ACCESS,
		.esp_desc = &(systolic_conv2d_cfg_000[0].esp),
	}
};
