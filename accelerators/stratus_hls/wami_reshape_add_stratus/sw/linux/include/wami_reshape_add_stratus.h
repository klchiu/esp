...
#ifndef _WAMI_RESHAPE_ADD_STRATUS_H_
#define _WAMI_RESHAPE_ADD_STRATUS_H_
...
struct wami_reshape_add_stratus_access {
...
#define WAMI_RESHAPE_ADD_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_reshape_add_stratus_access)

#endif /* _WAMI_RESHAPE_ADD_STRATUS_H_ */
