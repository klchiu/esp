...
#ifndef __GEMM16_HPP__
#define __GEMM16_HPP__

#include "gemm16_data.hpp"
#include "fpdata.hpp"
#include "gemm16_conf_info.hpp"
#include "gemm16_debug_info.hpp"
#include "esp_templates.hpp"
#include "gemm16_directives.hpp"
#include "common.hpp"

#define __round_mask(x, y) ((y)-1)
#define round_up(x, y) ((((x)-1) | __round_mask(x, y))+1)

class gemm16 : public esp_accelerator_3P<DMA_WIDTH>
{
public:

    // Constructor
    SC_HAS_PROCESS(gemm16);
    gemm16(const sc_module_name& name)
