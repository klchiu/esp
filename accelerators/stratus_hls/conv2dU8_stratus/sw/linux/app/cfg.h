...
struct conv2dU8_stratus_access conv2dU8_cfg_000[] = {
	{
		/* <<--descriptor-->> */
...
esp_thread_info_t cfg_000[] = {
	{
		// .run = true,
		// .devname = "conv2dU8_stratus.0",
		// .devname_noid = "conv2dU8_stratus",
		// .puffinname = "red",
		// .ioctl_req = CONV2DU8_STRATUS_IOC_ACCESS,
		// .esp_desc = &(conv2dU8_cfg_000[0].esp),
	// },
	// {
		.run = true,
		.devname = "conv2dU8_stratus.1",
		.devname_noid = "conv2dU8_stratus",
		.puffinname = "green",
		.ioctl_req = CONV2DU8_STRATUS_IOC_ACCESS,
		.esp_desc = &(conv2dU8_cfg_000[0].esp),
