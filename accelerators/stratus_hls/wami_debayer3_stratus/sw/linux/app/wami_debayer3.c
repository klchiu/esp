...
#include "cfg_wami_debayer3.h"

#define DEVNAME "/dev/wami_debayer3_stratus.0"
#define NAME    "wami_debayer3_stratus"
...
static void init_buf(struct wami_debayer3_test *t)
{
    printf("init buffers\n");
...
{
    printf("=== Helloo from wami_debayer3\n");
    ...
    cfg_wami_debayer3[0].hw_buf = buf;
    
    printf("---- debug 4\n");
    esp_run(cfg_wami_debayer3, 1);
    printf("---- debug 5\n");
    esp_free(buf);
    printf("---- debug 6\n");
