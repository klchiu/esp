...
#ifndef __CFG_P2P_A_H__
#define __CFG_P2P_A_H__
...
struct wami_synth4_stratus_access wami_synth4_cfg_p2p_a[] = {
    /* wami_synth4_0 */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
    ...
    /* wami_synth4_4 */
    {
        ...
        .esp.p2p_store         = 1,
        .esp.p2p_nsrcs         = 1,
        .esp.p2p_srcs          = {"wami_synth4_stratus.3", "", "", ""},
    },
    /* wami_synth4_5*/
    {
        .src_offset            = 0,
...
esp_thread_info_t cfg_wami_synth4_p2p_a[] = {
    /* blank placeholder for formatter */
    {
        .run       = true,
        .devname   = "wami_synth4_stratus.0",
        .ioctl_req = WAMI_SYNTH4_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth4_cfg_p2p_a[0].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth4_stratus.1",
        .ioctl_req = WAMI_SYNTH4_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth4_cfg_p2p_a[1].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth4_stratus.2",
        .ioctl_req = WAMI_SYNTH4_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth4_cfg_p2p_a[2].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth4_stratus.3",
        .ioctl_req = WAMI_SYNTH4_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth4_cfg_p2p_a[3].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth4_stratus.4",
        .ioctl_req = WAMI_SYNTH4_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth4_cfg_p2p_a[4].esp),
    },
    {
        .run       = true,
        .devname   = "wami_synth4_stratus.5",
        .ioctl_req = WAMI_SYNTH4_STRATUS_IOC_ACCESS,
        .esp_desc  = &(wami_synth4_cfg_p2p_a[5].esp),
    }};

#endif /* __CFG_P2P_A_H__ */
