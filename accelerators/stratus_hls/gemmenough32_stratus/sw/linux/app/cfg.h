...
struct gemmenough32_stratus_access gemmenough32_cfg_000[] = {
	{
		/* <<--descriptor-->> */
		.ninputs = NINPUTS,
		.d3 = D3,
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "gemmenough32_stratus.0",
		.ioctl_req = GEMMENOUGH32_STRATUS_IOC_ACCESS,
		.esp_desc = &(gemmenough32_cfg_000[0].esp),
	}
};
