...
#
define_hls_module gemm8 ../src/gemm8.cpp

#
# Testbench or system level modules
#
define_system_module ../tb/gemm8_pv.c
...
foreach chk $DMA_CHUNK {
	...
	foreach word $WORD_SIZE {
		...
		foreach tb $TESTBENCHES {
		    ...
		    define_sim_config "BEHAV_$conf\_$tb" "gemm8 BEH" \
		...
		foreach cfg [list BASIC] {
		    ...
		    define_hls_config gemm8 $cname -io_config IOCFG_$conf \
			...
			if {$TECH_IS_XILINX == 1} {
			    define_sim_config "$cname\_$tb\_V" "gemm8 RTL_V $cname" \
				"tb TESTBENCH_$conf" -io_config IOCFG_$conf \
