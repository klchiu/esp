...
public:
        ...
        : esp_system<DMA_WIDTH, MEM_SIZE>(name)
    {
        // ACC
#ifdef CADENCE
        acc = new huangemm3s8_wrapper("huangemm3s8_wrapper");
#else
        acc = new huangemm3s8("huangemm3s8_wrapper");
#endif
        // Binding ACC
        acc->clk(clk);
        acc->rst(acc_rst);
