...
#ifndef _WAMI_SUB3_STRATUS_H_
#define _WAMI_SUB3_STRATUS_H_
...
struct wami_sub3_stratus_access {
...
#define WAMI_SUB3_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_sub3_stratus_access)

#endif /* _WAMI_SUB3_STRATUS_H_ */
