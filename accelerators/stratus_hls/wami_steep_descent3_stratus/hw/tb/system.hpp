...
#ifdef CADENCE
    #include "wami_steep_descent3_wrap.h"
#endif
...
class system_t : public esp_system<DMA_WIDTH, MEM_SIZE>
{
  public:
    // ACC instance
#ifdef CADENCE
    wami_steep_descent3_wrapper *acc;
#else
    wami_steep_descent3 *acc;
#endif
        ...
        : esp_system<DMA_WIDTH, MEM_SIZE>(name)
    {
        // ACC
#ifdef CADENCE
        acc = new wami_steep_descent3_wrapper("wami_steep_descent3_wrapper");
#else
        acc = new wami_steep_descent3("wami_steep_descent3_wrapper");
#endif
        // Binding ACC
        acc->clk(clk);
        acc->rst(acc_rst);
