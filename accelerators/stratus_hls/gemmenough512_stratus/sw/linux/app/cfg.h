...
struct gemmenough512_stratus_access gemmenough512_cfg_000[] = {
	{
		/* <<--descriptor-->> */
		.ninputs = NINPUTS,
		.d3 = D3,
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "gemmenough512_stratus.0",
		.ioctl_req = GEMMENOUGH512_STRATUS_IOC_ACCESS,
		.esp_desc = &(gemmenough512_cfg_000[0].esp),
	}
};
