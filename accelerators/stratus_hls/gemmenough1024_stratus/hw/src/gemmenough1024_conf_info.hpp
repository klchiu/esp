...
#ifndef __GEMMENOUGH1024_CONF_INFO_HPP__
#define __GEMMENOUGH1024_CONF_INFO_HPP__
...
public:
    ...
    conf_info_t()
    {
        ...
        this->d2 = 1024;
        this->d1 = 1024;
        this->st_offset = 2097152;
        this->ld_offset1 = 0;
        this->ld_offset2 = 1048576;
    }
...
#endif // __GEMMENOUGH1024_CONF_INFO_HPP__
