...
#ifndef __GEMM32_HPP__
#define __GEMM32_HPP__

#include "gemm32_data.hpp"
#include "fpdata.hpp"
#include "gemm32_conf_info.hpp"
#include "gemm32_debug_info.hpp"
#include "esp_templates.hpp"
#include "gemm32_directives.hpp"
#include "common.hpp"

#define __round_mask(x, y) ((y)-1)
#define round_up(x, y) ((((x)-1) | __round_mask(x, y))+1)

class gemm32 : public esp_accelerator_3P<DMA_WIDTH>
{
public:

    // Constructor
    SC_HAS_PROCESS(gemm32);
    gemm32(const sc_module_name& name)
