...
#ifndef __WAMI_SYNTH4_HPP__
#define __WAMI_SYNTH4_HPP__
...
#include "wami_synth4_debug_info.hpp"
#include "wami_synth4_directives.hpp"

#include "esp_templates.hpp"

#include "utils/esp_handshake.hpp"

class wami_synth4 : public esp_accelerator_3P<DMA_WIDTH>
{
  public:
    // Output <-> Input
    ...
    // Constructor
    SC_HAS_PROCESS(wami_synth4);
    wami_synth4(const sc_module_name &name)
...
inline void wami_synth4::store_load_handshake()
{
    {
...
inline void wami_synth4::load_store_handshake()
{
    {
