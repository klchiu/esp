...
#include "cfg_wami_hessian_inv.h"

#define DEVNAME "/dev/wami_hessian_inv_stratus.0"
#define NAME    "wami_hessian_inv_stratus"
...
static void init_buf(struct wami_hessian_inv_test *t)
{
    printf("init buffers\n");
...
{
    printf("=== Helloo from wami_hessian_inv\n");
    ...
    cfg_wami_hessian_inv[0].hw_buf = buf;
    
    printf("---- debug 4\n");
    esp_run(cfg_wami_hessian_inv, 1);
    printf("---- debug 5\n");
    esp_free(buf);
    printf("---- debug 6\n");
