...
#define WAMI_RUN_IMG_NUM_IMGS NUM_IMGS
#define WAMI_RUN_IMG_NUM_ROWS (WAMI_DEBAYER_IMG_NUM_ROWS - (2 * PAD))
#define WAMI_RUN_IMG_NUM_COLS (WAMI_DEBAYER_IMG_NUM_COLS - (2 * PAD))
...
#define RESHAPE_ADD_KERN_ID    14
#define HESSIAN_INV_KERN_ID    15
#define STEEP_DESCENT_HESSIAN_KERN_ID    16
#define MULT_RESHAPE_ADD_KERN_ID    17
#define SYNTH_KERN_ID    18
