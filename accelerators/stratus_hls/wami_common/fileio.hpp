                           ...
                           float **sigma, float **weight, uint32_t *nTestImages, uint16_t **images, uint8_t **results)
{
  ...
  unsigned word = 0, hi = 0, low = 0;
    ...
    *start_image = (flt_pixel_t *)malloc(sizeof(flt_pixel_t) * *nRows * *nCols);
    ...
    *mu     = (float *)malloc(sizeof(float) * *nRows * *nCols * *nModels);
    *sigma  = (float *)malloc(sizeof(float) * *nRows * *nCols * *nModels);
    *weight = (float *)malloc(sizeof(float) * *nRows * *nCols * *nModels);
    ...
    *images  = (uint16_t *)malloc(sizeof(uint16_t) * *srcRows * *srcCols * *nTestImages);
    *results = (uint8_t *)malloc(sizeof(uint8_t) * *nRows * *nCols * *nTestImages);
