...
#include "wami_mult_reshape_add_functions.hpp"

// Processes

void wami_mult_reshape_add::load_input()
{
    ...
    for (uint32_t img = 0; img < img_num_img; img++) {
        ...
        //-- printf("[load_input]: debug 4\n");

        // == BURST 2 (read input 6) ====================================================
...
void wami_mult_reshape_add::store_output()
{
    ...
    // Config
    {
        ...
        is_p2p               = config.batch; // [humu]: TODO: change batch to is_p2p
        img_num_img          = config.num_img;
        num_forward_pass     = config.src_dst_offset_3;
        num_backward_pass    = config.src_dst_offset_4;
    }
...
void wami_mult_reshape_add::compute_kernel()
{
    uint32_t img_num_img = 0;
    // Reset
    {
