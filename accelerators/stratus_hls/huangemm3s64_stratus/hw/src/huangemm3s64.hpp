...
#ifndef __HUANGEMM3S64_HPP__
#define __HUANGEMM3S64_HPP__

#include "huangemm3s64_conf_info.hpp"
#include "huangemm3s64_debug_info.hpp"

#include "esp_templates.hpp"

#include "huangemm3s64_directives.hpp"
...
#define PLM_IN_WORD 64

class huangemm3s64 : public esp_accelerator_3P<DMA_WIDTH>
{
public:
    // Constructor
    SC_HAS_PROCESS(huangemm3s64);
    huangemm3s64(const sc_module_name& name)
