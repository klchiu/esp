...
struct gemmenough256_stratus_access gemmenough256_cfg_000[] = {
	{
		/* <<--descriptor-->> */
		.ninputs = NINPUTS,
		.d3 = D3,
...
esp_thread_info_t cfg_000[] = {
	{
		.run = true,
		.devname = "gemmenough256_stratus.0",
		.ioctl_req = GEMMENOUGH256_STRATUS_IOC_ACCESS,
		.esp_desc = &(gemmenough256_cfg_000[0].esp),
	}
};
