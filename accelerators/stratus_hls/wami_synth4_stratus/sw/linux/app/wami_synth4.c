...
//--------------------------------------------------------------------------------------
void run_synth3_0_mtm_a(void *ptr) { esp_run_no_print(cfg_wami_synth4_0_mtm_a, 1); }
void run_synth3_1_mtm_a(void *ptr) { esp_run_no_print(cfg_wami_synth4_1_mtm_a, 1); }
void run_synth3_2_mtm_a(void *ptr) { esp_run_no_print(cfg_wami_synth4_2_mtm_a, 1); }
void run_synth3_3_mtm_a(void *ptr) { esp_run_no_print(cfg_wami_synth4_3_mtm_a, 1); }
void run_synth3_4_mtm_a(void *ptr) { esp_run_no_print(cfg_wami_synth4_4_mtm_a, 1); }
void run_synth3_5_mtm_a(void *ptr) { esp_run_no_print(cfg_wami_synth4_5_mtm_a, 1); }

void run_synth3_0_mtm_b(void *ptr) { esp_run_no_print(cfg_wami_synth4_0_mtm_b, 1); }
void run_synth3_1_mtm_b(void *ptr) { esp_run_no_print(cfg_wami_synth4_1_mtm_b, 1); }
void run_synth3_2_mtm_b(void *ptr) { esp_run_no_print(cfg_wami_synth4_2_mtm_b, 1); }
void run_synth3_3_mtm_b(void *ptr) { esp_run_no_print(cfg_wami_synth4_3_mtm_b, 1); }
void run_synth3_4_mtm_b(void *ptr) { esp_run_no_print(cfg_wami_synth4_4_mtm_b, 1); }
void run_synth3_5_mtm_b(void *ptr) { esp_run_no_print(cfg_wami_synth4_5_mtm_b, 1); }

void run_synth3_0_mtm_c(void *ptr) { esp_run_no_print(cfg_wami_synth4_0_mtm_c, 1); }
void run_synth3_1_mtm_c(void *ptr) { esp_run_no_print(cfg_wami_synth4_1_mtm_c, 1); }
void run_synth3_2_mtm_c(void *ptr) { esp_run_no_print(cfg_wami_synth4_2_mtm_c, 1); }
void run_synth3_3_mtm_c(void *ptr) { esp_run_no_print(cfg_wami_synth4_3_mtm_c, 1); }
void run_synth3_4_mtm_c(void *ptr) { esp_run_no_print(cfg_wami_synth4_4_mtm_c, 1); }
void run_synth3_5_mtm_c(void *ptr) { esp_run_no_print(cfg_wami_synth4_5_mtm_c, 1); }
