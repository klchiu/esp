...
struct wami_synth4_stratus_access wami_synth4_cfg_stm_a[] = {
    /* <<--descriptor-->> */
    {
        .src_offset            = 0,
        .dst_offset            = 0,
...
esp_thread_info_t cfg_wami_synth4_0_stm_a[] = {{
    .run       = true,
    .devname   = "wami_synth4_stratus.0",
    .ioctl_req = WAMI_SYNTH4_STRATUS_IOC_ACCESS,
    .esp_desc  = &(wami_synth4_cfg_stm_a[0].esp),
}};

esp_thread_info_t cfg_wami_synth4_1_stm_a[] = {{
    .run       = true,
...
esp_thread_info_t cfg_wami_synth4_2_stm_a[] = {{
    .run       = true,
...
esp_thread_info_t cfg_wami_synth4_3_stm_a[] = {{
    .run       = true,
...
esp_thread_info_t cfg_wami_synth4_4_stm_a[] = {{
    .run       = true,
...
esp_thread_info_t cfg_wami_synth4_5_stm_a[] = {{
    .run       = true,
