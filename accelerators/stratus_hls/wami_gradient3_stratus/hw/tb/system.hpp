...
class system_t : public esp_system<DMA_WIDTH, MEM_SIZE>
{
  public:
        ...
        : esp_system<DMA_WIDTH, MEM_SIZE>(name)
    {
        // ACC
#ifdef CADENCE
        acc = new wami_gradient3_wrapper("wami_gradient3_wrapper");
#else
        acc = new wami_gradient3("wami_gradient3_wrapper");
#endif
        // Binding ACC
        acc->clk(clk);
        acc->rst(acc_rst);
