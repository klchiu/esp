...
#
define_hls_module ny_acc ../src/ny_acc.cpp
...
foreach dma_width [list 64] {
    ...
    define_sim_config "BEHAV_$ext" "ny_acc BEH" "tb TESTBENCH_$ext" \
        -io_config IOCFG_$ext -argv $DEFAULT_ARGV

	foreach cfg [list BASIC] {
        set cname $cfg\_$ext
        define_hls_config ny_acc $cname -io_config IOCFG_$ext \
            $COMMON_HLS_FLAGS -DHLS_DIRECTIVES_$cfg

		if {$TECH_IS_XILINX == 1} {
		    define_sim_config "$cname\_V" "ny_acc RTL_V $cname" "tb TESTBENCH_$ext" \
