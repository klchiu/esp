...
#ifndef __GEMMENOUGH2048_CONF_INFO_HPP__
#define __GEMMENOUGH2048_CONF_INFO_HPP__
...
public:
    ...
    conf_info_t()
    {
        ...
        this->d2 = 2048;
        this->d1 = 2048;
        this->st_offset = 8388608;
        this->ld_offset1 = 0;
        this->ld_offset2 = 4194304;
    }
...
#endif // __GEMMENOUGH2048_CONF_INFO_HPP__
