...
#include "cfg_wami_steep_descent3.h"

#define DEVNAME "/dev/wami_steep_descent3_stratus.0"
#define NAME    "wami_steep_descent3_stratus"
...
static void init_buf(struct wami_steep_descent3_test *t)
{
    printf("init buffers\n");
...
{
    printf("=== Helloo from wami_steep_descent3\n");
    ...
    cfg_wami_steep_descent3[0].hw_buf = buf;
    
    printf("---- debug 4\n");
    esp_run(cfg_wami_steep_descent3, 1);
    printf("---- debug 5\n");
    esp_free(buf);
    printf("---- debug 6\n");
