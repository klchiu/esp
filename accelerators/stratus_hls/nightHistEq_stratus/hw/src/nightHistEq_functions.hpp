...
#ifndef __NIGHTHISTEQ_FUNCTIONS_HPP__
#define __NIGHTHISTEQ_FUNCTIONS_HPP__
...
void nightHistEq::kernel_hist(uint32_t n_Rows, uint32_t n_Cols)
{
...
void nightHistEq::dwt_row_transpose(uint32_t n_Rows, uint32_t n_Cols, int16_t buff1[PLM_IMG_SIZE],
