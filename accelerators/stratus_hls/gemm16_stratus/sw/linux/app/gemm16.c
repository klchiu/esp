			    ...
			    unsigned *in_size, unsigned *out_size, unsigned *size)
{
    ...
    *size = *in_size + *out_size;
    ...
    gemm16_cfg_000[0].do_relu = do_relu;
    gemm16_cfg_000[0].transpose = transpose;
    gemm16_cfg_000[0].ninputs = ninputs;
    gemm16_cfg_000[0].d1 = d1;
    gemm16_cfg_000[0].d2 = d2;
    gemm16_cfg_000[0].d3 = d3;
    gemm16_cfg_000[0].ld_offset1 = ld_offset1;
    gemm16_cfg_000[0].ld_offset2 = ld_offset2;
    gemm16_cfg_000[0].st_offset = st_offset;
