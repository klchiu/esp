...
#ifndef _WAMI_GMM3_STRATUS_H_
#define _WAMI_GMM3_STRATUS_H_
...
struct wami_gmm3_stratus_access {
...
#define WAMI_GMM3_STRATUS_IOC_ACCESS _IOW('S', 0, struct wami_gmm3_stratus_access)

#endif /* _WAMI_GMM3_STRATUS_H_ */
