...
#ifndef __GEMMENOUGH128_CONF_INFO_HPP__
#define __GEMMENOUGH128_CONF_INFO_HPP__
...
public:
    ...
    conf_info_t()
    {
        ...
        this->d2 = 128;
        this->d1 = 128;
        this->st_offset = 32768;
        this->ld_offset1 = 0;
        this->ld_offset2 = 16384;
    }
...
#endif // __GEMMENOUGH128_CONF_INFO_HPP__
