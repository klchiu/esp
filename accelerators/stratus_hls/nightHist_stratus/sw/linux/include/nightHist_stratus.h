...
#ifndef _NIGHTHIST_STRATUS_H_
#define _NIGHTHIST_STRATUS_H_
...
struct nightHist_stratus_access {
...
#define NIGHTHIST_STRATUS_IOC_ACCESS _IOW('S', 0, struct nightHist_stratus_access)

#endif /* _NIGHTHIST_STRATUS_H_ */
